...
int s18_kernel_gen(char *Name) {
    ...
    if (Kernel) {
        ...
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 6400, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,       2);
        AddKernelArgDimExplicit(Name, "expr_0_in_0", ARG_INT,     4, 16, 16, 8, 1);
        AddKernelArgDimExplicit(Name, "expr_0_in_1", ARG_INT,     4, 16, 16, 8, 1);
        AddKernelArgDimExplicit(Name, "expr_0_out_0", ARG_INT,    4, 16, 16, 8, 1);
    }
    return (Kernel!=0);
}
int s188_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
        // shape: (1, 4, 3, 2) spaces: ((1,), (2,), (3,)) 
        // fixed_spaces: ((1,),) parametric_spaces: ((2,), (3,)) 
        // exterior_shape: (4, 3, 2.0) 
        KernelIterSpace(4, IterFixedSpace(KER_ITER_D0, 4), IterParSpace(KER_ITER_D1, 3, 8), IterParSpace(KER_ITER_D2, 2, 1), IterTiledSpace(KER_ITER_TILE0)),
        TILE_VER,
        CArgs(5,
    ...
    if (Kernel) {
        AddKernelInfos(Name, AT_KERINFO_OPER, 120, 0);
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 314, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,     2);
        AddKernelArgDimExplicit(Name, "expr_1_in_0", ARG_INT,     4, 4, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_1_in_1", ARG_INT,     4, 4, 1, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_1_in_2", ARG_INT,     2, 2,       1);
        AddKernelArgDimExplicit(Name, "expr_1_out_0", ARG_INT,    4, 4, 3, 2, 1);
    }
    return (Kernel!=0);
}
int s213_kernel_gen(char *Name) {
    ...
    if (Kernel) {
        ...
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,      2);
        AddKernelArgDimExplicit(Name, "expr_2_in_0", ARG_INT,     4, 16, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_2_in_1", ARG_INT,     4, 16, 1, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_2_in_2", ARG_INT,     2, 2,        1);
        AddKernelArgDimExplicit(Name, "expr_2_out_0", ARG_INT,    4, 16, 3, 2, 1);
    }
    return (Kernel!=0);
}
int s220_kernel_gen(char *Name) {
    ...
    if (Kernel) {
        ...
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,      2);
        AddKernelArgDimExplicit(Name, "expr_3_in_0", ARG_INT,     4, 64, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_3_in_1", ARG_INT,     4, 64, 1, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_3_in_2", ARG_INT,     2, 2,        1);
        AddKernelArgDimExplicit(Name, "expr_3_out_0", ARG_INT,    4, 64, 3, 2, 1);
    }
    return (Kernel!=0);
}
int s37_kernel_gen(char *Name) {
    ...
    if (Kernel) {
        AddKernelInfos(Name, AT_KERINFO_OPER, 3072, 0);
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 3328, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,      2);
        AddKernelArgDimExplicit(Name, "expr_4_in_0", ARG_INT,     4, 8, 8, 16, 1);
        AddKernelArgDimExplicit(Name, "expr_4_in_1", ARG_INT,     4, 8, 8, 16, 1);
        AddKernelArgDimExplicit(Name, "expr_4_out_0", ARG_INT,    4, 8, 8, 16, 1);
    }
    return (Kernel!=0);
}
int s57_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
        // shape: (4, 4, 28) spaces: ((0, 1, 2),) 
        // parametric_spaces: ((0, 1, 2),) 
        // exterior_shape: (448.0,) 
        KernelIterSpace(2, IterParSpace(KER_ITER_D0, 448, 8), IterTiledSpace(KER_ITER_TILE0)),
        TILE_VER,
        CArgs(4,
    ...
    if (Kernel) {
        AddKernelInfos(Name, AT_KERINFO_OPER, 1344, 0);
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 1600, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,      2);
        AddKernelArgDimExplicit(Name, "expr_5_in_0", ARG_INT,     4, 4, 4, 28, 1);
        AddKernelArgDimExplicit(Name, "expr_5_in_1", ARG_INT,     4, 4, 4, 28, 1);
        AddKernelArgDimExplicit(Name, "expr_5_out_0", ARG_INT,    4, 4, 4, 28, 1);
    }
    return (Kernel!=0);
}
int s76_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
        // shape: (2, 2, 52) spaces: ((0, 1, 2),) 
        // parametric_spaces: ((0, 1, 2),) 
        // exterior_shape: (208.0,) 
        KernelIterSpace(2, IterParSpace(KER_ITER_D0, 208, 8), IterTiledSpace(KER_ITER_TILE0)),
        TILE_VER,
        CArgs(4,
    ...
    if (Kernel) {
        AddKernelInfos(Name, AT_KERINFO_OPER, 624, 0);
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 880, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,      2);
        AddKernelArgDimExplicit(Name, "expr_6_in_0", ARG_INT,     4, 2, 2, 52, 1);
        AddKernelArgDimExplicit(Name, "expr_6_in_1", ARG_INT,     4, 2, 2, 52, 1);
        AddKernelArgDimExplicit(Name, "expr_6_out_0", ARG_INT,    4, 2, 2, 52, 1);
    }
    return (Kernel!=0);
}
int s209_kernel_gen(char *Name) {
    ...
    if (Kernel) {
        AddKernelInfos(Name, AT_KERINFO_OPER, 96, 0);
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 312, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,     2);
        AddKernelArgDimExplicit(Name, "expr_32_in_0", ARG_INT,    4, 4, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_32_in_1", ARG_INT,    3, 3, 2,    1);
        AddKernelArgDimExplicit(Name, "expr_32_in_2", ARG_INT,    2, 2,       1);
        AddKernelArgDimExplicit(Name, "expr_32_out_0", ARG_INT,   4, 4, 3, 2, 1);
    }
    return (Kernel!=0);
}
int s215_kernel_gen(char *Name) {
    ...
    if (Kernel) {
        ...
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,      2);
        AddKernelArgDimExplicit(Name, "expr_34_in_0", ARG_INT,    4, 16, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_34_in_1", ARG_INT,    3, 3, 2,     1);
        AddKernelArgDimExplicit(Name, "expr_34_in_2", ARG_INT,    2, 2,        1);
        AddKernelArgDimExplicit(Name, "expr_34_out_0", ARG_INT,   4, 16, 3, 2, 1);
    }
    return (Kernel!=0);
}
int s222_kernel_gen(char *Name) {
    ...
    if (Kernel) {
        ...
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,      2);
        AddKernelArgDimExplicit(Name, "expr_35_in_0", ARG_INT,    4, 64, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_35_in_1", ARG_INT,    3, 3, 2,     1);
        AddKernelArgDimExplicit(Name, "expr_35_in_2", ARG_INT,    2, 2,        1);
        AddKernelArgDimExplicit(Name, "expr_35_out_0", ARG_INT,   4, 64, 3, 2, 1);
    }
    return (Kernel!=0);
}
...
void YOLOv5Model(unsigned int L1Memory, unsigned int L2Memory, unsigned int L3Memory, unsigned int L3Flash)
{
    ...
    CNN_SplitLastAxis_Generator2("S10_CONV_2D_0_7_split", &gen_ctrl_S10_CONV_2D_0_7_split, -1, 256, 2, KOP_SPLIT, 8,8);
    
    
    // generator for CONV_2D_0_7_split_copy_qout0
    CNN_Convert("S11_CONV_2D_0_7_split_copy_qout0", -1, -1, 2048, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S19_CONCAT_0_20", &gen_ctrl_S19_CONCAT_0_20, -1, 256, 2, KOP_CONCAT, 8,8);
    ...
    CNN_SplitLastAxis_Generator2("S29_CONV_2D_0_28_split", &gen_ctrl_S29_CONV_2D_0_28_split, -1, 64, 2, KOP_SPLIT, 16,16);
    
    
    // generator for CONV_2D_0_28_split_copy_qout0
    CNN_Convert("S30_CONV_2D_0_28_split_copy_qout0", -1, -1, 1024, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S38_CONCAT_0_41", &gen_ctrl_S38_CONCAT_0_41, -1, 64, 2, KOP_CONCAT, 16,16);
    ...
    CNN_Convert("S42_CONV_2D_0_42_fusion_qout0", -1, -1, 2048, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_SplitLastAxis_Generator2("S49_CONV_2D_0_49_split", &gen_ctrl_S49_CONV_2D_0_49_split, -1, 16, 2, KOP_SPLIT, 28,28);
    
    
    // generator for CONV_2D_0_49_split_copy_qout0
    CNN_Convert("S50_CONV_2D_0_49_split_copy_qout0", -1, -1, 448, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S58_CONCAT_0_62", &gen_ctrl_S58_CONCAT_0_62, -1, 16, 2, KOP_CONCAT, 28,28);
    ...
    CNN_SplitLastAxis_Generator2("S68_CONV_2D_0_70_split", &gen_ctrl_S68_CONV_2D_0_70_split, -1, 4, 2, KOP_SPLIT, 52,52);
    
    
    // generator for CONV_2D_0_70_split_copy_qout0
    CNN_Convert("S69_CONV_2D_0_70_split_copy_qout0", -1, -1, 208, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S77_CONCAT_0_83", &gen_ctrl_S77_CONCAT_0_83, -1, 4, 2, KOP_CONCAT, 52,52);
    ...
    CNN_Convert("S84_CONV_2D_0_87_fusion_qout0", -1, -1, 208, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_Convert("S88_MAX_POOL_2D_0_92_qout0", -1, -1, 208, KOP_CONVERT_FP_FP_SCALE);
    
    
    // generator for MAX_POOL_2D_0_91_qout0
    CNN_Convert("S89_MAX_POOL_2D_0_91_qout0", -1, -1, 208, KOP_CONVERT_FP_FP_SCALE);
    
    
    // generator for MAX_POOL_2D_0_90_qout0
    CNN_Convert("S90_MAX_POOL_2D_0_90_qout0", -1, -1, 208, KOP_CONVERT_FP_FP_SCALE);
    
    
    // generator for CONV_2D_0_87_fusion_qout0_0
    CNN_Convert("S91_CONV_2D_0_87_fusion_qout0_0", -1, -1, 208, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S92_CONCAT_0_93", &gen_ctrl_S92_CONCAT_0_93, -1, 4, 4, KOP_CONCAT, 52,52,52,52);
    ...
    GenerateResizeMultiChannel("S99_RESIZE_NN_0_100", &gen_ctrl_S99_RESIZE_NN_0_100, 2, 2, 4, 4, 56, UNSIGNED_INOUT, KOP_NEAREST_NEIGHBOR_RESIZE);
    
    
    // generator for RESIZE_NN_0_100_qout0
    CNN_Convert("S100_RESIZE_NN_0_100_qout0", -1, -1, 896, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S101_CONCAT_0_101", &gen_ctrl_S101_CONCAT_0_101, -1, 16, 2, KOP_CONCAT, 56,56);
    
    
    // generator for CONV_2D_0_97_fusion_qout0
    CNN_Convert("S102_CONV_2D_0_97_fusion_qout0", -1, -1, 224, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_SplitLastAxis_Generator2("S106_CONV_2D_0_102_split", &gen_ctrl_S106_CONV_2D_0_102_split, -1, 16, 2, KOP_SPLIT, 28,28);
    
    
    // generator for CONV_2D_0_102_split_copy_qout0
    CNN_Convert("S107_CONV_2D_0_102_split_copy_qout0", -1, -1, 448, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S114_CONCAT_0_114", &gen_ctrl_S114_CONCAT_0_114, -1, 16, 2, KOP_CONCAT, 28,28);
    ...
    GenerateResizeMultiChannel("S121_RESIZE_NN_0_121", &gen_ctrl_S121_RESIZE_NN_0_121, 4, 4, 8, 8, 32, UNSIGNED_INOUT, KOP_NEAREST_NEIGHBOR_RESIZE);
    
    
    // generator for RESIZE_NN_0_121_qout0
    CNN_Convert("S122_RESIZE_NN_0_121_qout0", -1, -1, 2048, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S123_CONCAT_0_122", &gen_ctrl_S123_CONCAT_0_122, -1, 64, 2, KOP_CONCAT, 32,32);
    
    
    // generator for CONV_2D_0_118_fusion_qout0
    CNN_Convert("S124_CONV_2D_0_118_fusion_qout0", -1, -1, 512, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_SplitLastAxis_Generator2("S128_CONV_2D_0_123_split", &gen_ctrl_S128_CONV_2D_0_123_split, -1, 64, 2, KOP_SPLIT, 16,16);
    
    
    // generator for CONV_2D_0_123_split_copy_qout0
    CNN_Convert("S129_CONV_2D_0_123_split_copy_qout0", -1, -1, 1024, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S136_CONCAT_0_135", &gen_ctrl_S136_CONCAT_0_135, -1, 64, 2, KOP_CONCAT, 16,16);
    ...
    CNN_ConcatLastAxis_Generator2("S143_CONCAT_0_143", &gen_ctrl_S143_CONCAT_0_143, -1, 16, 2, KOP_CONCAT, 32,32);
    ...
    CNN_SplitLastAxis_Generator2("S147_CONV_2D_0_144_split", &gen_ctrl_S147_CONV_2D_0_144_split, -1, 16, 2, KOP_SPLIT, 28,28);
    
    
    // generator for CONV_2D_0_144_split_copy_qout0
    CNN_Convert("S148_CONV_2D_0_144_split_copy_qout0", -1, -1, 448, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S155_CONCAT_0_156", &gen_ctrl_S155_CONCAT_0_156, -1, 16, 2, KOP_CONCAT, 28,28);
    ...
    CNN_ConcatLastAxis_Generator2("S162_CONCAT_0_164", &gen_ctrl_S162_CONCAT_0_164, -1, 4, 2, KOP_CONCAT, 56,56);
    ...
    CNN_SplitLastAxis_Generator2("S166_CONV_2D_0_165_split", &gen_ctrl_S166_CONV_2D_0_165_split, -1, 4, 2, KOP_SPLIT, 52,52);
    
    
    // generator for CONV_2D_0_165_split_copy_qout0
    CNN_Convert("S167_CONV_2D_0_165_split_copy_qout0", -1, -1, 208, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S174_CONCAT_0_177", &gen_ctrl_S174_CONCAT_0_177, -1, 4, 2, KOP_CONCAT, 52,52);
    ...
    CNN_SplitLastAxis_Generator2("S182_STRIDED_SLICE_0_183_split", &gen_ctrl_S182_STRIDED_SLICE_0_183_split, -1, 12, 3, KOP_SPLIT, 2,2,2);
    ...
    CNN_Convert("S185_CONCAT_0_196_reshape_2_qout0", -1, -1, 24, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_SplitLastAxis_Generator2("S194_STRIDED_SLICE_0_200_split", &gen_ctrl_S194_STRIDED_SLICE_0_200_split, -1, 48, 3, KOP_SPLIT, 2,2,2);
    ...
    CNN_SplitLastAxis_Generator2("S203_STRIDED_SLICE_0_217_split", &gen_ctrl_S203_STRIDED_SLICE_0_217_split, -1, 192, 3, KOP_SPLIT, 2,2,2);
    ...
    CNN_ConcatLastAxis_Generator2("S210_CONCAT_0_196", &gen_ctrl_S210_CONCAT_0_196, -1, 12, 3, KOP_CONCAT, 2,2,2);
    ...
    CNN_ConcatLastAxis_Generator2("S216_CONCAT_0_213", &gen_ctrl_S216_CONCAT_0_213, -1, 48, 3, KOP_CONCAT, 2,2,2);
    
    
    // generator for RESHAPE_0_214_qout0
    CNN_Convert("S218_RESHAPE_0_214_qout0", -1, -1, 288, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S223_CONCAT_0_230", &gen_ctrl_S223_CONCAT_0_230, -1, 192, 3, KOP_CONCAT, 2,2,2);
    
    
    // generator for RESHAPE_0_231_qout0
    CNN_Convert("S225_RESHAPE_0_231_qout0", -1, -1, 1152, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_Copy("S228_CONCAT_0_232_reshape_copy", &gen_ctrl_S228_CONCAT_0_232_reshape_copy, 1512, -1);
...
#define GRAPH
    ...
    CreateGraph("YOLOv5CNN",
        /* Arguments either passed or globals */
            CArgs(273,
                ...
                // in: 0.14683 out: 0.08026  BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // in: 0.11572 out: 0.04439  BIASN: 0 PRENORM: 0 NE16_PADVAL: [3] NE16_WOFFSET: [-128]
                ...
                // in: 0.07768 out: 0.02762  BIASN: 0 PRENORM: 0 NE16_PADVAL: [6] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-10.00)*0.02761565<6.77 out_q: -0.57<(u8-20.00)*0.02874767<6.76
                ...
                // in: 0.03779 out: 0.01838  BIASN: 0 PRENORM: 0 NE16_PADVAL: [10] NE16_WOFFSET: [-128]
                ...
                // in: 0.04318 out: 0.01942  BIASN: 0 PRENORM: 0 NE16_PADVAL: [20] NE16_WOFFSET: [-128]
                ...
                // in: 0.02914 out: 0.01171  BIASN: 0 PRENORM: 0 NE16_PADVAL: [14] NE16_WOFFSET: [-128]
                ...
                // in: 0.02780 out: 0.01138  BIASN: 0 PRENORM: 0 NE16_PADVAL: [24] NE16_WOFFSET: [-128]
                ...
                // in q: -0.27<(u8-24.00)*0.01138002<2.63 out_q: -0.55<(u8-39.00)*0.01411954<3.05
                ...
                // in: 0.02520 out: 0.01279  BIASN: 0 PRENORM: 0 NE16_PADVAL: [24] NE16_WOFFSET: [-128]
                ...
                // in: 0.02419 out: 0.01546  BIASN: 0 PRENORM: 0 NE16_PADVAL: [39] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-18.00)*0.01545944<3.66 out_q: -0.28<(u8-18.00)*0.01546216<3.66
                ...
                // in: 0.02264 out: 0.01386  BIASN: 0 PRENORM: 0 NE16_PADVAL: [18] NE16_WOFFSET: [-128]
                ...
                // in: 0.01906 out: 0.01110  BIASN: 0 PRENORM: 0 NE16_PADVAL: [20] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-25.00)*0.01110406<2.55 out_q: -0.56<(u8-36.00)*0.01566924<3.43
                ...
                // in: 0.01971 out: 0.01156  BIASN: 0 PRENORM: 0 NE16_PADVAL: [25] NE16_WOFFSET: [-128]
                ...
                // no activation BIASN: 0 PRENORM: 0 NE16_PADVAL: [24] NE16_WOFFSET: [-128]
                ...
                // in: 0.02035 out: 0.00975  BIASN: 0 PRENORM: 0 NE16_PADVAL: [36] NE16_WOFFSET: [-128]
                ...
                // in: 0.01834 out: 0.00907  BIASN: 0 PRENORM: 0 NE16_PADVAL: [29] NE16_WOFFSET: [-128]
                ...
                // in: 0.02062 out: 0.01233  BIASN: 0 PRENORM: 0 NE16_PADVAL: [31] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-23.00)*0.01233214<2.86 out_q: -0.52<(u8-39.00)*0.01324782<2.86
                ...
                // in: 0.01593 out: 0.00887  BIASN: 0 PRENORM: 0 NE16_PADVAL: [23] NE16_WOFFSET: [-128]
                ...
                // in: 0.02206 out: 0.01113  BIASN: 0 PRENORM: 0 NE16_PADVAL: [39] NE16_WOFFSET: [-128]
                ...
                // in: 0.02128 out: 0.01350  BIASN: 0 PRENORM: 0 NE16_PADVAL: [25] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-21.00)*0.01350352<3.16 out_q: 0.00<(u8-0.00)*0.01241151<3.16 forced
                ...
                // in q: 0.00<(u8-0.00)*0.01241151<3.16 forced out_q: -0.28<(u8-21.00)*0.01352356<3.16
                ...
                // in q: -0.28<(u8-21.00)*0.01350352<3.16 out_q: -0.28<(u8-21.00)*0.01352356<3.16
                ...
                // in: 0.01464 out: 0.00910  BIASN: 0 PRENORM: 0 NE16_PADVAL: [21] NE16_WOFFSET: [-128]
                ...
                // in: 0.00798 out: 0.00452  BIASN: 0 PRENORM: 0 NE16_PADVAL: [31] NE16_WOFFSET: [-128]
                ...
                // in q: -0.25<(u8-56.00)*0.00452404<0.90 out_q: -0.28<(u8-29.00)*0.00974856<2.20
                ...
                // in q: -0.25<(u8-56.00)*0.00452404<0.90 out_q: -0.27<(u8-27.00)*0.01017256<2.32
                ...
                // in: 0.01695 out: 0.01097  BIASN: 0 PRENORM: 0 NE16_PADVAL: [29] NE16_WOFFSET: [-128]
                ...
                // in q: -0.27<(u8-25.00)*0.01096718<2.52 out_q: -0.27<(u8-25.00)*0.01097904<2.53
                ...
                // in: 0.02043 out: 0.01053  BIASN: 0 PRENORM: 0 NE16_PADVAL: [25] NE16_WOFFSET: [-128]
                ...
                // in: 0.01959 out: 0.01098  BIASN: 0 PRENORM: 0 NE16_PADVAL: [26] NE16_WOFFSET: [-128]
                ...
                // in: 0.02152 out: 0.01159  BIASN: 0 PRENORM: 0 NE16_PADVAL: [25] NE16_WOFFSET: [-128]
                ...
                // in: 0.01471 out: 0.00680  BIASN: 0 PRENORM: 0 NE16_PADVAL: [24] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-41.00)*0.00680400<1.46 out_q: -0.28<(u8-18.00)*0.01546216<3.66
                ...
                // in q: -0.28<(u8-41.00)*0.00680400<1.46 out_q: -0.28<(u8-22.00)*0.01254094<2.92
                ...
                // in: 0.02338 out: 0.01300  BIASN: 0 PRENORM: 0 NE16_PADVAL: [18] NE16_WOFFSET: [-128]
                ...
                // in q: -0.27<(u8-21.00)*0.01300063<3.04 out_q: -0.28<(u8-16.00)*0.01774539<4.24
                ...
                // in: 0.03101 out: 0.01581  BIASN: 0 PRENORM: 0 NE16_PADVAL: [21] NE16_WOFFSET: [-128]
                ...
                // in: 0.03657 out: 0.01775  BIASN: 0 PRENORM: 0 NE16_PADVAL: [18] NE16_WOFFSET: [-128]
                ...
                // in: 0.03876 out: 0.02111  BIASN: 0 PRENORM: 0 NE16_PADVAL: [16] NE16_WOFFSET: [-128]
                ...
                // in: 0.02188 out: 0.01254  BIASN: 0 PRENORM: 0 NE16_PADVAL: [13] NE16_WOFFSET: [-128]
                ...
                // in: 0.01912 out: 0.00977  BIASN: 0 PRENORM: 0 NE16_PADVAL: [22] NE16_WOFFSET: [-128]
                ...
                // in q: -0.27<(u8-28.00)*0.00977145<2.22 out_q: -0.28<(u8-20.00)*0.01387680<3.26
                ...
                // in: 0.02160 out: 0.01156  BIASN: 0 PRENORM: 0 NE16_PADVAL: [28] NE16_WOFFSET: [-128]
                ...
                // in: 0.02349 out: 0.01388  BIASN: 0 PRENORM: 0 NE16_PADVAL: [24] NE16_WOFFSET: [-128]
                ...
                // in: 0.02229 out: 0.01499  BIASN: 0 PRENORM: 0 NE16_PADVAL: [20] NE16_WOFFSET: [-128]
                ...
                // in: 0.02050 out: 0.01017  BIASN: 0 PRENORM: 0 NE16_PADVAL: [19] NE16_WOFFSET: [-128]
                ...
                // in: 0.02442 out: 0.01375  BIASN: 0 PRENORM: 0 NE16_PADVAL: [27] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-20.00)*0.01375396<3.23 out_q: -0.28<(u8-20.00)*0.01378120<3.24
                ...
                // in: 0.01656 out: 0.00921  BIASN: 0 PRENORM: 0 NE16_PADVAL: [20] NE16_WOFFSET: [-128]
                ...
                // in: 0.01875 out: 0.01378  BIASN: 0 PRENORM: 0 NE16_PADVAL: [30] NE16_WOFFSET: [-128]
                ...
                // in: 0.02082 out: 0.01103  BIASN: 0 PRENORM: 0 NE16_PADVAL: [20] NE16_WOFFSET: [-128]
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -1.51<(u8-128.00)*0.01176347<1.49 forced
    ...
    AddStackedTensors(
        "S226_Output",
        3, "S225_Output", "S218_Output", "S210_Output"
    );

    // Node S3_CONV_2D_0_0_fusion inq 0.00<(u8-0.00)*0.00392157<1.00 weightsq chan<(u8-128.00)*chan<chan outq -0.24<(u8-3.00)*0.08025537<20.22 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S6_CONV_2D_0_4_fusion inq -0.24<(u8-3.00)*0.08025537<20.22 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-6.00)*0.04438846<11.05 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S9_CONV_2D_0_7_fusion inq -0.27<(u8-6.00)*0.04438846<11.05 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-10.00)*0.02761565<6.77 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_7_split inq -0.28<(u8-10.00)*0.02761565<6.77 outq -0.28<(u8-10.00)*0.02761565<6.77
    ...
    // Node CONV_2D_0_7_split_copy_qout0 inq -0.28<(u8-10.00)*0.02761565<6.77 outq -0.57<(u8-20.00)*0.02874767<6.76
    ...
    // Node S14_CONV_2D_0_10_fusion inq -0.28<(u8-10.00)*0.02761565<6.77 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-15.00)*0.01837985<4.41 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S17_CONV_2D_0_13 inq -0.28<(u8-15.00)*0.01837985<4.41 weightsq chan<(u8-128.00)*chan<chan outq -4.46<(u8-118.00)*0.03775966<5.17 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_0 in_qs [-4.46<(u8-118.00)*0.03775966<5.17,-0.28<(u8-10.00)*0.02761565<6.77] out_qs [-0.57<(u8-20.00)*0.02874767<6.76]
    AddNode("S18_expr_0",
        Bindings(4,
    ...
    // Node CONCAT_0_20 inq -0.57<(u8-20.00)*0.02874767<6.76 outq -0.57<(u8-20.00)*0.02874767<6.76
    ...
    // Node S22_CONV_2D_0_21_fusion inq -0.57<(u8-20.00)*0.02874767<6.76 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-14.00)*0.01942149<4.68 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S25_CONV_2D_0_25_fusion inq -0.27<(u8-14.00)*0.01942149<4.68 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-24.00)*0.01170825<2.70 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S28_CONV_2D_0_28_fusion inq -0.28<(u8-24.00)*0.01170825<2.70 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-24.00)*0.01138002<2.63 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_28_split inq -0.27<(u8-24.00)*0.01138002<2.63 outq -0.27<(u8-24.00)*0.01138002<2.63
    ...
    // Node CONV_2D_0_28_split_copy_qout0 inq -0.27<(u8-24.00)*0.01138002<2.63 outq -0.55<(u8-39.00)*0.01411954<3.05
    ...
    // Node S33_CONV_2D_0_31_fusion inq -0.27<(u8-24.00)*0.01138002<2.63 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-22.00)*0.01278506<2.98 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S36_CONV_2D_0_34 inq -0.28<(u8-22.00)*0.01278506<2.98 weightsq chan<(u8-128.00)*chan<chan outq -2.30<(u8-123.00)*0.01866420<2.46 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_4 in_qs [-2.30<(u8-123.00)*0.01866420<2.46,-0.27<(u8-24.00)*0.01138002<2.63] out_qs [-0.55<(u8-39.00)*0.01411954<3.05]
    AddNode("S37_expr_4",
        Bindings(4,
    ...
    // Node CONCAT_0_41 inq -0.55<(u8-39.00)*0.01411954<3.05 outq -0.55<(u8-39.00)*0.01411954<3.05
    ...
    // Node S41_CONV_2D_0_42_fusion inq -0.55<(u8-39.00)*0.01411954<3.05 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-18.00)*0.01545944<3.66 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_42_fusion_qout0 inq -0.28<(u8-18.00)*0.01545944<3.66 outq -0.28<(u8-18.00)*0.01546216<3.66
    ...
    // Node S45_CONV_2D_0_46_fusion inq -0.28<(u8-18.00)*0.01545944<3.66 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-20.00)*0.01385717<3.26 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S48_CONV_2D_0_49_fusion inq -0.28<(u8-20.00)*0.01385717<3.26 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-25.00)*0.01110406<2.55 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_49_split inq -0.28<(u8-25.00)*0.01110406<2.55 outq -0.28<(u8-25.00)*0.01110406<2.55
    ...
    // Node CONV_2D_0_49_split_copy_qout0 inq -0.28<(u8-25.00)*0.01110406<2.55 outq -0.56<(u8-36.00)*0.01566924<3.43
    ...
    // Node S53_CONV_2D_0_52_fusion inq -0.28<(u8-25.00)*0.01110406<2.55 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-24.00)*0.01155936<2.67 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S56_CONV_2D_0_55 inq -0.28<(u8-24.00)*0.01155936<2.67 weightsq chan<(u8-128.00)*chan<chan outq -1.74<(u8-100.00)*0.01741349<2.70 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_5 in_qs [-1.74<(u8-100.00)*0.01741349<2.70,-0.28<(u8-25.00)*0.01110406<2.55] out_qs [-0.56<(u8-36.00)*0.01566924<3.43]
    AddNode("S57_expr_5",
        Bindings(4,
    ...
    // Node CONCAT_0_62 inq -0.56<(u8-36.00)*0.01566924<3.43 outq -0.56<(u8-36.00)*0.01566924<3.43
    ...
    // Node S61_CONV_2D_0_63_fusion inq -0.56<(u8-36.00)*0.01566924<3.43 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-29.00)*0.00974856<2.20 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S64_CONV_2D_0_67_fusion inq -0.28<(u8-29.00)*0.00974856<2.20 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-31.00)*0.00907278<2.03 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S67_CONV_2D_0_70_fusion inq -0.28<(u8-31.00)*0.00907278<2.03 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-23.00)*0.01233214<2.86 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_70_split inq -0.28<(u8-23.00)*0.01233214<2.86 outq -0.28<(u8-23.00)*0.01233214<2.86
    ...
    // Node CONV_2D_0_70_split_copy_qout0 inq -0.28<(u8-23.00)*0.01233214<2.86 outq -0.52<(u8-39.00)*0.01324782<2.86
    ...
    // Node S72_CONV_2D_0_73_fusion inq -0.28<(u8-23.00)*0.01233214<2.86 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-31.00)*0.00887358<1.99 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S75_CONV_2D_0_76 inq -0.28<(u8-31.00)*0.00887358<1.99 weightsq chan<(u8-128.00)*chan<chan outq -2.03<(u8-127.00)*0.01600108<2.05 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_6 in_qs [-2.03<(u8-127.00)*0.01600108<2.05,-0.28<(u8-23.00)*0.01233214<2.86] out_qs [-0.52<(u8-39.00)*0.01324782<2.86]
    AddNode("S76_expr_6",
        Bindings(4,
    ...
    // Node CONCAT_0_83 inq -0.52<(u8-39.00)*0.01324782<2.86 outq -0.52<(u8-39.00)*0.01324782<2.86
    ...
    // Node S80_CONV_2D_0_84_fusion inq -0.52<(u8-39.00)*0.01324782<2.86 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-25.00)*0.01113403<2.56 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S83_CONV_2D_0_87_fusion inq -0.28<(u8-25.00)*0.01113403<2.56 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-21.00)*0.01350352<3.16 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_87_fusion_qout0 inq -0.28<(u8-21.00)*0.01350352<3.16 outq 0.00<(u8-0.00)*0.01241151<3.16 forced
    ...
    // Node MAX_POOL_2D_0_90 inq 0.00<(u8-0.00)*0.01241151<3.16 forced outq 0.00<(u8-0.00)*0.01241151<3.16 forced
    ...
    // Node MAX_POOL_2D_0_91 inq 0.00<(u8-0.00)*0.01241151<3.16 forced outq 0.00<(u8-0.00)*0.01241151<3.16 forced
    ...
    // Node MAX_POOL_2D_0_92 inq 0.00<(u8-0.00)*0.01241151<3.16 forced outq 0.00<(u8-0.00)*0.01241151<3.16 forced
    ...
    // Node MAX_POOL_2D_0_92_qout0 inq 0.00<(u8-0.00)*0.01241151<3.16 forced outq -0.28<(u8-21.00)*0.01352356<3.16
    ...
    // Node MAX_POOL_2D_0_91_qout0 inq 0.00<(u8-0.00)*0.01241151<3.16 forced outq -0.28<(u8-21.00)*0.01352356<3.16
    ...
    // Node MAX_POOL_2D_0_90_qout0 inq 0.00<(u8-0.00)*0.01241151<3.16 forced outq -0.28<(u8-21.00)*0.01352356<3.16
    ...
    // Node CONV_2D_0_87_fusion_qout0_0 inq -0.28<(u8-21.00)*0.01350352<3.16 outq -0.28<(u8-21.00)*0.01352356<3.16
    ...
    // Node CONCAT_0_93 inq -0.28<(u8-21.00)*0.01352356<3.16 outq -0.28<(u8-21.00)*0.01352356<3.16
    ...
    // Node S95_CONV_2D_0_94_fusion inq -0.28<(u8-21.00)*0.01352356<3.16 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-31.00)*0.00910293<2.04 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S98_CONV_2D_0_97_fusion inq -0.28<(u8-31.00)*0.00910293<2.04 weightsq chan<(u8-128.00)*chan<chan outq -0.25<(u8-56.00)*0.00452404<0.90 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node RESIZE_NN_0_100 inq -0.25<(u8-56.00)*0.00452404<0.90 outq -0.25<(u8-56.00)*0.00452404<0.90
    ...
    // Node RESIZE_NN_0_100_qout0 inq -0.25<(u8-56.00)*0.00452404<0.90 outq -0.28<(u8-29.00)*0.00974856<2.20
    ...
    // Node CONCAT_0_101 inq -0.28<(u8-29.00)*0.00974856<2.20 outq -0.28<(u8-29.00)*0.00974856<2.20
    ...
    // Node CONV_2D_0_97_fusion_qout0 inq -0.25<(u8-56.00)*0.00452404<0.90 outq -0.27<(u8-27.00)*0.01017256<2.32
    ...
    // Node S105_CONV_2D_0_102_fusion inq -0.28<(u8-29.00)*0.00974856<2.20 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-25.00)*0.01096718<2.52 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_102_split inq -0.27<(u8-25.00)*0.01096718<2.52 outq -0.27<(u8-25.00)*0.01096718<2.52
    ...
    // Node CONV_2D_0_102_split_copy_qout0 inq -0.27<(u8-25.00)*0.01096718<2.52 outq -0.27<(u8-25.00)*0.01097904<2.53
    ...
    // Node S110_CONV_2D_0_105_fusion inq -0.27<(u8-25.00)*0.01096718<2.52 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-26.00)*0.01052545<2.41 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S113_CONV_2D_0_108_fusion inq -0.27<(u8-26.00)*0.01052545<2.41 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-25.00)*0.01097904<2.53 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_114 inq -0.27<(u8-25.00)*0.01097904<2.53 outq -0.27<(u8-25.00)*0.01097904<2.53
    ...
    // Node S117_CONV_2D_0_115_fusion inq -0.27<(u8-25.00)*0.01097904<2.53 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-24.00)*0.01158700<2.68 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S120_CONV_2D_0_118_fusion inq -0.28<(u8-24.00)*0.01158700<2.68 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-41.00)*0.00680400<1.46 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node RESIZE_NN_0_121 inq -0.28<(u8-41.00)*0.00680400<1.46 outq -0.28<(u8-41.00)*0.00680400<1.46
    ...
    // Node RESIZE_NN_0_121_qout0 inq -0.28<(u8-41.00)*0.00680400<1.46 outq -0.28<(u8-18.00)*0.01546216<3.66
    ...
    // Node CONCAT_0_122 inq -0.28<(u8-18.00)*0.01546216<3.66 outq -0.28<(u8-18.00)*0.01546216<3.66
    ...
    // Node CONV_2D_0_118_fusion_qout0 inq -0.28<(u8-41.00)*0.00680400<1.46 outq -0.28<(u8-22.00)*0.01254094<2.92
    ...
    // Node S127_CONV_2D_0_123_fusion inq -0.28<(u8-18.00)*0.01546216<3.66 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-21.00)*0.01300063<3.04 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_123_split inq -0.27<(u8-21.00)*0.01300063<3.04 outq -0.27<(u8-21.00)*0.01300063<3.04
    ...
    // Node CONV_2D_0_123_split_copy_qout0 inq -0.27<(u8-21.00)*0.01300063<3.04 outq -0.28<(u8-16.00)*0.01774539<4.24
    ...
    // Node S132_CONV_2D_0_126_fusion inq -0.27<(u8-21.00)*0.01300063<3.04 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-18.00)*0.01580904<3.75 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S135_CONV_2D_0_129_fusion inq -0.28<(u8-18.00)*0.01580904<3.75 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-16.00)*0.01774539<4.24 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_135 inq -0.28<(u8-16.00)*0.01774539<4.24 outq -0.28<(u8-16.00)*0.01774539<4.24
    ...
    // Node S139_CONV_2D_0_136_fusion inq -0.28<(u8-16.00)*0.01774539<4.24 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-13.00)*0.02110872<5.11 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S142_CONV_2D_0_140_fusion inq -0.27<(u8-13.00)*0.02110872<5.11 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-22.00)*0.01254094<2.92 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_143 inq -0.28<(u8-22.00)*0.01254094<2.92 outq -0.28<(u8-22.00)*0.01254094<2.92
    ...
    // Node S146_CONV_2D_0_144_fusion inq -0.28<(u8-22.00)*0.01254094<2.92 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-28.00)*0.00977145<2.22 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_144_split inq -0.27<(u8-28.00)*0.00977145<2.22 outq -0.27<(u8-28.00)*0.00977145<2.22
    ...
    // Node CONV_2D_0_144_split_copy_qout0 inq -0.27<(u8-28.00)*0.00977145<2.22 outq -0.28<(u8-20.00)*0.01387680<3.26
    ...
    // Node S151_CONV_2D_0_147_fusion inq -0.27<(u8-28.00)*0.00977145<2.22 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-24.00)*0.01155511<2.67 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S154_CONV_2D_0_150_fusion inq -0.28<(u8-24.00)*0.01155511<2.67 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-20.00)*0.01387680<3.26 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_156 inq -0.28<(u8-20.00)*0.01387680<3.26 outq -0.28<(u8-20.00)*0.01387680<3.26
    ...
    // Node S158_CONV_2D_0_157_fusion inq -0.28<(u8-20.00)*0.01387680<3.26 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-19.00)*0.01499084<3.54 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S161_CONV_2D_0_161_fusion inq -0.28<(u8-19.00)*0.01499084<3.54 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-27.00)*0.01017256<2.32 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_164 inq -0.27<(u8-27.00)*0.01017256<2.32 outq -0.27<(u8-27.00)*0.01017256<2.32
    ...
    // Node S165_CONV_2D_0_165_fusion inq -0.27<(u8-27.00)*0.01017256<2.32 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-20.00)*0.01375396<3.23 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_165_split inq -0.28<(u8-20.00)*0.01375396<3.23 outq -0.28<(u8-20.00)*0.01375396<3.23
    ...
    // Node CONV_2D_0_165_split_copy_qout0 inq -0.28<(u8-20.00)*0.01375396<3.23 outq -0.28<(u8-20.00)*0.01378120<3.24
    ...
    // Node S170_CONV_2D_0_168_fusion inq -0.28<(u8-20.00)*0.01375396<3.23 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-30.00)*0.00920563<2.07 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S173_CONV_2D_0_171_fusion inq -0.28<(u8-30.00)*0.00920563<2.07 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-20.00)*0.01378120<3.24 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_177 inq -0.28<(u8-20.00)*0.01378120<3.24 outq -0.28<(u8-20.00)*0.01378120<3.24
    ...
    // Node S177_CONV_2D_0_178_fusion inq -0.28<(u8-20.00)*0.01378120<3.24 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-25.00)*0.01102513<2.54 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S180_CONV_2D_0_181 inq -0.28<(u8-25.00)*0.01102513<2.54 weightsq chan<(u8-128.00)*chan<chan outq -6.29<(u8-128.00)*0.04913386<6.24 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_196_reshape_2_qout0 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -1.51<(u8-128.00)*0.01176347<1.49 forced
    ...
    // Node expr_1 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-0.50<(i8-0.00)*0.00393701<0.50,-0.02<(i8-0.00)*0.00012303<0.02] out_qs [-1.51<(u8-128.00)*0.01176347<1.49 forced]
    AddNode("S188_expr_1",
        Bindings(5,
    ...
    // Node S192_CONV_2D_0_198 inq -0.28<(u8-19.00)*0.01499084<3.54 weightsq chan<(u8-128.00)*chan<chan outq -6.29<(u8-128.00)*0.04913386<6.24 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S201_CONV_2D_0_215 inq -0.27<(u8-13.00)*0.02110872<5.11 weightsq chan<(u8-128.00)*chan<chan outq -6.29<(u8-128.00)*0.04913386<6.24 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_32 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-96.50<(i8-0.00)*0.75393701<95.75,-0.02<(i8-0.00)*0.00012303<0.02] out_qs [-1.51<(u8-128.00)*0.01176347<1.49 forced]
    ...
    // Node CONCAT_0_196 inq -1.51<(u8-128.00)*0.01176347<1.49 forced outq -1.51<(u8-128.00)*0.01176347<1.49 forced
    ...
    // Node expr_2 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-2.52<(i8-0.00)*0.01968504<2.50,-0.02<(i8-0.00)*0.00012303<0.02] out_qs [0.00<(u8-0.00)*0.00392157<1.00]
    AddNode("S213_expr_2",
        Bindings(5,
    ...
    // Node expr_34 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-30.63<(i8-0.00)*0.23929626<30.39,-0.02<(i8-0.00)*0.00012303<0.02] out_qs [0.00<(u8-0.00)*0.00392157<1.00]
    ...
    // Node CONCAT_0_213 inq 0.00<(u8-0.00)*0.00392157<1.00 outq 0.00<(u8-0.00)*0.00392157<1.00
    ...
    // Node RESHAPE_0_214_qout0 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -1.51<(u8-128.00)*0.01176347<1.49 forced
    AddNode("S218_RESHAPE_0_214_qout0",
        Bindings(3,
    ...
    // Node expr_3 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-6.55<(i8-0.00)*0.05118110<6.50,-0.02<(i8-0.00)*0.00012303<0.02] out_qs [0.00<(u8-0.00)*0.00392157<1.00]
    AddNode("S220_expr_3",
        Bindings(5,
    ...
    // Node expr_35 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-14.11<(i8-0.00)*0.11023622<14.00,-0.02<(i8-0.00)*0.00012303<0.02] out_qs [0.00<(u8-0.00)*0.00392157<1.00]
    ...
    // Node RESHAPE_0_231_qout0 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -1.51<(u8-128.00)*0.01176347<1.49 forced
    AddNode("S225_RESHAPE_0_231_qout0",
        Bindings(3,
    ...
    // Node CONCAT_0_232_reshape_copy inq -1.51<(u8-128.00)*0.01176347<1.49 forced outq -1.51<(u8-128.00)*0.01176347<1.49 forced
