...
int s18_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
        // shape: (96, 96, 8) spaces: ((0, 1, 2),) 
        // parametric_spaces: ((0, 1, 2),) 
        // exterior_shape: (73728.0,) 
        KernelIterSpace(2, IterParSpace(KER_ITER_D0, 73728, 8), IterTiledSpace(KER_ITER_TILE0)),
        TILE_VER,
        CArgs(4,
    ...
    if (Kernel) {
        AddKernelInfos(Name, AT_KERINFO_OPER, 221184, 0);
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 221440, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,       2);
        AddKernelArgDimExplicit(Name, "expr_0_in_0", ARG_INT,     4, 96, 96, 8, 1);
        AddKernelArgDimExplicit(Name, "expr_0_in_1", ARG_INT,     4, 96, 96, 8, 1);
        AddKernelArgDimExplicit(Name, "expr_0_out_0", ARG_INT,    4, 96, 96, 8, 1);
    }
    return (Kernel!=0);
}
int s187_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
    ...
    if (Kernel) {
        ...
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,       2);
        AddKernelArgDimExplicit(Name, "expr_1_in_0", ARG_INT,     4, 144, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_1_in_1", ARG_INT,     4, 144, 1, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_1_in_2", ARG_INT,     2, 2,         1);
        AddKernelArgDimExplicit(Name, "expr_1_out_0", ARG_INT,    4, 144, 3, 2, 1);
    }
    return (Kernel!=0);
}
int s214_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
    ...
    if (Kernel) {
        ...
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,       2);
        AddKernelArgDimExplicit(Name, "expr_2_in_0", ARG_INT,     4, 576, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_2_in_1", ARG_INT,     4, 576, 1, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_2_in_2", ARG_INT,     2, 2,         1);
        AddKernelArgDimExplicit(Name, "expr_2_out_0", ARG_INT,    4, 576, 3, 2, 1);
    }
    return (Kernel!=0);
}
int s220_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
        // shape: (1, 2304, 3, 2) spaces: ((1,), (2,), (3,)) 
        // fixed_spaces: ((1,),) parametric_spaces: ((2,), (3,)) 
        // exterior_shape: (2304, 3, 2.0) 
        KernelIterSpace(4, IterFixedSpace(KER_ITER_D0, 2304), IterParSpace(KER_ITER_D1, 3, 8), IterParSpace(KER_ITER_D2, 2, 1), IterTiledSpace(KER_ITER_TILE0)),
        TILE_VER,
        CArgs(5,
    ...
    if (Kernel) {
        AddKernelInfos(Name, AT_KERINFO_OPER, 69120, 0);
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 32514, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,        2);
        AddKernelArgDimExplicit(Name, "expr_3_in_0", ARG_INT,     4, 2304, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_3_in_1", ARG_INT,     4, 2304, 1, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_3_in_2", ARG_INT,     2, 2,          1);
        AddKernelArgDimExplicit(Name, "expr_3_out_0", ARG_INT,    4, 2304, 3, 2, 1);
    }
    return (Kernel!=0);
}
int s37_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
        // shape: (48, 48, 16) spaces: ((0, 1, 2),) 
        // parametric_spaces: ((0, 1, 2),) 
        // exterior_shape: (36864.0,) 
        KernelIterSpace(2, IterParSpace(KER_ITER_D0, 36864, 8), IterTiledSpace(KER_ITER_TILE0)),
        TILE_VER,
        CArgs(4,
    ...
    if (Kernel) {
        AddKernelInfos(Name, AT_KERINFO_OPER, 110592, 0);
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 110848, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,        2);
        AddKernelArgDimExplicit(Name, "expr_4_in_0", ARG_INT,     4, 48, 48, 16, 1);
        AddKernelArgDimExplicit(Name, "expr_4_in_1", ARG_INT,     4, 48, 48, 16, 1);
        AddKernelArgDimExplicit(Name, "expr_4_out_0", ARG_INT,    4, 48, 48, 16, 1);
    }
    return (Kernel!=0);
}
int s57_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
        // shape: (24, 24, 28) spaces: ((0, 1, 2),) 
        // parametric_spaces: ((0, 1, 2),) 
        // exterior_shape: (16128.0,) 
        KernelIterSpace(2, IterParSpace(KER_ITER_D0, 16128, 8), IterTiledSpace(KER_ITER_TILE0)),
        TILE_VER,
        CArgs(4,
    ...
    if (Kernel) {
        AddKernelInfos(Name, AT_KERINFO_OPER, 48384, 0);
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 48640, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,        2);
        AddKernelArgDimExplicit(Name, "expr_5_in_0", ARG_INT,     4, 24, 24, 28, 1);
        AddKernelArgDimExplicit(Name, "expr_5_in_1", ARG_INT,     4, 24, 24, 28, 1);
        AddKernelArgDimExplicit(Name, "expr_5_out_0", ARG_INT,    4, 24, 24, 28, 1);
    }
    return (Kernel!=0);
}
int s76_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
        // shape: (12, 12, 52) spaces: ((0, 1, 2),) 
        // parametric_spaces: ((0, 1, 2),) 
        // exterior_shape: (7488.0,) 
        KernelIterSpace(2, IterParSpace(KER_ITER_D0, 7488, 8), IterTiledSpace(KER_ITER_TILE0)),
        TILE_VER,
        CArgs(4,
    ...
    if (Kernel) {
        AddKernelInfos(Name, AT_KERINFO_OPER, 22464, 0);
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 22720, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,        2);
        AddKernelArgDimExplicit(Name, "expr_6_in_0", ARG_INT,     4, 12, 12, 52, 1);
        AddKernelArgDimExplicit(Name, "expr_6_in_1", ARG_INT,     4, 12, 12, 52, 1);
        AddKernelArgDimExplicit(Name, "expr_6_out_0", ARG_INT,    4, 12, 12, 52, 1);
    }
    return (Kernel!=0);
}
int s210_kernel_gen(char *Name) {
    ...
    if (Kernel) {
        ...
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,       2);
        AddKernelArgDimExplicit(Name, "expr_32_in_0", ARG_INT,    4, 144, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_32_in_1", ARG_INT,    3, 3, 2,      1);
        AddKernelArgDimExplicit(Name, "expr_32_in_2", ARG_INT,    2, 2,         1);
        AddKernelArgDimExplicit(Name, "expr_32_out_0", ARG_INT,   4, 144, 3, 2, 1);
    }
    return (Kernel!=0);
}
int s216_kernel_gen(char *Name) {
    ...
    if (Kernel) {
        ...
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,       2);
        AddKernelArgDimExplicit(Name, "expr_34_in_0", ARG_INT,    4, 576, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_34_in_1", ARG_INT,    3, 3, 2,      1);
        AddKernelArgDimExplicit(Name, "expr_34_in_2", ARG_INT,    2, 2,         1);
        AddKernelArgDimExplicit(Name, "expr_34_out_0", ARG_INT,   4, 576, 3, 2, 1);
    }
    return (Kernel!=0);
}
int s222_kernel_gen(char *Name) {
    Kernel_T *Kernel = UserKernel(
        Name,
        // shape: (1, 2304, 3, 2) spaces: ((1,), (2,), (3,)) 
        // fixed_spaces: ((1,),) parametric_spaces: ((2,), (3,)) 
    ...
    if (Kernel) {
        ...
        AddKernelInfos(Name, AT_KERINFO_BANDWIDTH, 27912, 0);
        AddKernelArgDimExplicit(Name, "SigmoidLUTTable", ARG_INT, 2, 256,        2);
        AddKernelArgDimExplicit(Name, "expr_35_in_0", ARG_INT,    4, 2304, 3, 2, 1);
        AddKernelArgDimExplicit(Name, "expr_35_in_1", ARG_INT,    3, 3, 2,       1);
        AddKernelArgDimExplicit(Name, "expr_35_in_2", ARG_INT,    2, 2,          1);
        AddKernelArgDimExplicit(Name, "expr_35_out_0", ARG_INT,   4, 2304, 3, 2, 1);
    }
    return (Kernel!=0);
}
...
void YOLOv5Model(unsigned int L1Memory, unsigned int L2Memory, unsigned int L3Memory, unsigned int L3Flash)
{
    ...
    CNN_SplitLastAxis_Generator2("S10_CONV_2D_0_7_split", &gen_ctrl_S10_CONV_2D_0_7_split, -1, 9216, 2, KOP_SPLIT, 8,8);
    
    
    // generator for CONV_2D_0_7_split_copy_qout0
    CNN_Convert("S11_CONV_2D_0_7_split_copy_qout0", -1, -1, 73728, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S19_CONCAT_0_20", &gen_ctrl_S19_CONCAT_0_20, -1, 9216, 2, KOP_CONCAT, 8,8);
    ...
    CNN_SplitLastAxis_Generator2("S29_CONV_2D_0_28_split", &gen_ctrl_S29_CONV_2D_0_28_split, -1, 2304, 2, KOP_SPLIT, 16,16);
    
    
    // generator for CONV_2D_0_28_split_copy_qout0
    CNN_Convert("S30_CONV_2D_0_28_split_copy_qout0", -1, -1, 36864, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S38_CONCAT_0_41", &gen_ctrl_S38_CONCAT_0_41, -1, 2304, 2, KOP_CONCAT, 16,16);
    ...
    CNN_Convert("S42_CONV_2D_0_42_fusion_qout0", -1, -1, 73728, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_SplitLastAxis_Generator2("S49_CONV_2D_0_49_split", &gen_ctrl_S49_CONV_2D_0_49_split, -1, 576, 2, KOP_SPLIT, 28,28);
    
    
    // generator for CONV_2D_0_49_split_copy_qout0
    CNN_Convert("S50_CONV_2D_0_49_split_copy_qout0", -1, -1, 16128, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S58_CONCAT_0_62", &gen_ctrl_S58_CONCAT_0_62, -1, 576, 2, KOP_CONCAT, 28,28);
    ...
    CNN_SplitLastAxis_Generator2("S68_CONV_2D_0_70_split", &gen_ctrl_S68_CONV_2D_0_70_split, -1, 144, 2, KOP_SPLIT, 52,52);
    
    
    // generator for CONV_2D_0_70_split_copy_qout0
    CNN_Convert("S69_CONV_2D_0_70_split_copy_qout0", -1, -1, 7488, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S77_CONCAT_0_83", &gen_ctrl_S77_CONCAT_0_83, -1, 144, 2, KOP_CONCAT, 52,52);
    ...
    CNN_Convert("S84_CONV_2D_0_87_fusion_qout0", -1, -1, 7488, KOP_CONVERT_FP_FP_SCALE);
    
    
    // generator for CONV_2D_0_87_fusion_qout0_0
    CNN_Convert("S85_CONV_2D_0_87_fusion_qout0_0", -1, -1, 7488, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_Convert("S89_MAX_POOL_2D_0_92_qout0", -1, -1, 7488, KOP_CONVERT_FP_FP_SCALE);
    
    
    // generator for MAX_POOL_2D_0_91_qout0
    CNN_Convert("S90_MAX_POOL_2D_0_91_qout0", -1, -1, 7488, KOP_CONVERT_FP_FP_SCALE);
    
    
    // generator for MAX_POOL_2D_0_90_qout0
    CNN_Convert("S91_MAX_POOL_2D_0_90_qout0", -1, -1, 7488, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S92_CONCAT_0_93", &gen_ctrl_S92_CONCAT_0_93, -1, 144, 4, KOP_CONCAT, 52,52,52,52);
    ...
    GenerateResizeMultiChannel("S99_RESIZE_NN_0_100", &gen_ctrl_S99_RESIZE_NN_0_100, 12, 12, 24, 24, 56, UNSIGNED_INOUT, KOP_NEAREST_NEIGHBOR_RESIZE);
    
    
    // generator for RESIZE_NN_0_100_qout0
    CNN_Convert("S100_RESIZE_NN_0_100_qout0", -1, -1, 32256, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S101_CONCAT_0_101", &gen_ctrl_S101_CONCAT_0_101, -1, 576, 2, KOP_CONCAT, 56,56);
    
    
    // generator for CONV_2D_0_97_fusion_qout0
    CNN_Convert("S102_CONV_2D_0_97_fusion_qout0", -1, -1, 8064, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_SplitLastAxis_Generator2("S106_CONV_2D_0_102_split", &gen_ctrl_S106_CONV_2D_0_102_split, -1, 576, 2, KOP_SPLIT, 28,28);
    ...
    CNN_ConcatLastAxis_Generator2("S113_CONCAT_0_114", &gen_ctrl_S113_CONCAT_0_114, -1, 576, 2, KOP_CONCAT, 28,28);
    ...
    GenerateResizeMultiChannel("S120_RESIZE_NN_0_121", &gen_ctrl_S120_RESIZE_NN_0_121, 24, 24, 48, 48, 32, UNSIGNED_INOUT, KOP_NEAREST_NEIGHBOR_RESIZE);
    
    
    // generator for RESIZE_NN_0_121_qout0
    CNN_Convert("S121_RESIZE_NN_0_121_qout0", -1, -1, 73728, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S122_CONCAT_0_122", &gen_ctrl_S122_CONCAT_0_122, -1, 2304, 2, KOP_CONCAT, 32,32);
    
    
    // generator for CONV_2D_0_118_fusion_qout0
    CNN_Convert("S123_CONV_2D_0_118_fusion_qout0", -1, -1, 18432, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_SplitLastAxis_Generator2("S127_CONV_2D_0_123_split", &gen_ctrl_S127_CONV_2D_0_123_split, -1, 2304, 2, KOP_SPLIT, 16,16);
    
    
    // generator for CONV_2D_0_123_split_copy_qout0
    CNN_Convert("S128_CONV_2D_0_123_split_copy_qout0", -1, -1, 36864, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S135_CONCAT_0_135", &gen_ctrl_S135_CONCAT_0_135, -1, 2304, 2, KOP_CONCAT, 16,16);
    ...
    CNN_ConcatLastAxis_Generator2("S142_CONCAT_0_143", &gen_ctrl_S142_CONCAT_0_143, -1, 576, 2, KOP_CONCAT, 32,32);
    ...
    CNN_SplitLastAxis_Generator2("S146_CONV_2D_0_144_split", &gen_ctrl_S146_CONV_2D_0_144_split, -1, 576, 2, KOP_SPLIT, 28,28);
    
    
    // generator for CONV_2D_0_144_split_copy_qout0
    CNN_Convert("S147_CONV_2D_0_144_split_copy_qout0", -1, -1, 16128, KOP_CONVERT_FP_FP_SCALE);
    
    CNN_GenControl_T gen_ctrl_S150_CONV_2D_0_147_fusion;
    CNN_InitGenCtrl(&gen_ctrl_S150_CONV_2D_0_147_fusion);
    CNN_SetGenCtrl(&gen_ctrl_S150_CONV_2D_0_147_fusion, "CUSTOM_ACTIVATION_NAME", "expr_21");
    CNN_ExtraActivationArgs_T gen_ctrl_S150_CONV_2D_0_147_fusion_extra_activation_args = {1, {{"SigmoidLUTTable", 256, -2}}};
    CNN_SetGenCtrl(&gen_ctrl_S150_CONV_2D_0_147_fusion, "EXTRA_ACTIVATION_ARGS", &gen_ctrl_S150_CONV_2D_0_147_fusion_extra_activation_args);
    CNN_SetGenCtrl(&gen_ctrl_S150_CONV_2D_0_147_fusion, "INPUT_DATASIZE", AT_OPT_VAL(-1));
    CNN_SetGenCtrl(&gen_ctrl_S150_CONV_2D_0_147_fusion, "OUTPUT_DATASIZE", AT_OPT_VAL(-1));
    // generator for CONV_2D_0_147_fusion
    CNN_ConvolutionNE16("S150_CONV_2D_0_147_fusion", &gen_ctrl_S150_CONV_2D_0_147_fusion,
                        -1, -1, 4, 1, 8,
                        28, 28, 24, 24,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 17,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_GenControl_T gen_ctrl_S153_CONV_2D_0_150_fusion;
    CNN_InitGenCtrl(&gen_ctrl_S153_CONV_2D_0_150_fusion);
    CNN_SetGenCtrl(&gen_ctrl_S153_CONV_2D_0_150_fusion, "CUSTOM_ACTIVATION_NAME", "expr_22");
    CNN_ExtraActivationArgs_T gen_ctrl_S153_CONV_2D_0_150_fusion_extra_activation_args = {1, {{"SigmoidLUTTable", 256, -2}}};
    CNN_SetGenCtrl(&gen_ctrl_S153_CONV_2D_0_150_fusion, "EXTRA_ACTIVATION_ARGS", &gen_ctrl_S153_CONV_2D_0_150_fusion_extra_activation_args);
    CNN_SetGenCtrl(&gen_ctrl_S153_CONV_2D_0_150_fusion, "INPUT_DATASIZE", AT_OPT_VAL(-1));
    CNN_SetGenCtrl(&gen_ctrl_S153_CONV_2D_0_150_fusion, "OUTPUT_DATASIZE", AT_OPT_VAL(-1));
    // generator for CONV_2D_0_150_fusion
    CNN_ConvolutionNE16("S153_CONV_2D_0_150_fusion", &gen_ctrl_S153_CONV_2D_0_150_fusion,
                        -1, -1, 4, 1, 8,
                        28, 28, 24, 24,
    ...
    CNN_GenControl_T gen_ctrl_S154_CONCAT_0_156;
    CNN_InitGenCtrl(&gen_ctrl_S154_CONCAT_0_156);
    CNN_SetGenCtrl(&gen_ctrl_S154_CONCAT_0_156, "ARG_DTYPE", AT_OPT_VAL(ARG_INT));
    
    CNN_ConcatLastAxis_Generator2("S154_CONCAT_0_156", &gen_ctrl_S154_CONCAT_0_156, -1, 576, 2, KOP_CONCAT, 28,28);
    
    CNN_GenControl_T gen_ctrl_S157_CONV_2D_0_157_fusion;
    CNN_InitGenCtrl(&gen_ctrl_S157_CONV_2D_0_157_fusion);
    CNN_SetGenCtrl(&gen_ctrl_S157_CONV_2D_0_157_fusion, "CUSTOM_ACTIVATION_NAME", "expr_24");
    CNN_ExtraActivationArgs_T gen_ctrl_S157_CONV_2D_0_157_fusion_extra_activation_args = {1, {{"SigmoidLUTTable", 256, -2}}};
    CNN_SetGenCtrl(&gen_ctrl_S157_CONV_2D_0_157_fusion, "EXTRA_ACTIVATION_ARGS", &gen_ctrl_S157_CONV_2D_0_157_fusion_extra_activation_args);
    CNN_SetGenCtrl(&gen_ctrl_S157_CONV_2D_0_157_fusion, "INPUT_DATASIZE", AT_OPT_VAL(-1));
    CNN_SetGenCtrl(&gen_ctrl_S157_CONV_2D_0_157_fusion, "OUTPUT_DATASIZE", AT_OPT_VAL(-1));
    // generator for CONV_2D_0_157_fusion
    CNN_ConvolutionNE16("S157_CONV_2D_0_157_fusion", &gen_ctrl_S157_CONV_2D_0_157_fusion,
                        -1, -1, 4, 1, 8,
                        56, 56, 24, 24,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 17,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_GenControl_T gen_ctrl_S160_CONV_2D_0_161_fusion;
    CNN_InitGenCtrl(&gen_ctrl_S160_CONV_2D_0_161_fusion);
    CNN_SetGenCtrl(&gen_ctrl_S160_CONV_2D_0_161_fusion, "CUSTOM_ACTIVATION_NAME", "expr_25");
    CNN_ExtraActivationArgs_T gen_ctrl_S160_CONV_2D_0_161_fusion_extra_activation_args = {1, {{"SigmoidLUTTable", 256, -2}}};
    CNN_SetGenCtrl(&gen_ctrl_S160_CONV_2D_0_161_fusion, "EXTRA_ACTIVATION_ARGS", &gen_ctrl_S160_CONV_2D_0_161_fusion_extra_activation_args);
    CNN_SetGenCtrl(&gen_ctrl_S160_CONV_2D_0_161_fusion, "INPUT_DATASIZE", AT_OPT_VAL(-1));
    CNN_SetGenCtrl(&gen_ctrl_S160_CONV_2D_0_161_fusion, "OUTPUT_DATASIZE", AT_OPT_VAL(-1));
    // generator for CONV_2D_0_161_fusion
    CNN_ConvolutionNE16("S160_CONV_2D_0_161_fusion", &gen_ctrl_S160_CONV_2D_0_161_fusion,
                        -1, -1, 4, 1, 8,
                        56, 56, 24, 24,
                        KOP_CONV, 3, 3, 1, 1, 2, 2, 1, 17,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_GenControl_T gen_ctrl_S161_CONCAT_0_164;
    CNN_InitGenCtrl(&gen_ctrl_S161_CONCAT_0_164);
    CNN_SetGenCtrl(&gen_ctrl_S161_CONCAT_0_164, "ARG_DTYPE", AT_OPT_VAL(ARG_INT));
    
    CNN_ConcatLastAxis_Generator2("S161_CONCAT_0_164", &gen_ctrl_S161_CONCAT_0_164, -1, 144, 2, KOP_CONCAT, 56,56);
    
    CNN_GenControl_T gen_ctrl_S164_CONV_2D_0_165_fusion;
    CNN_InitGenCtrl(&gen_ctrl_S164_CONV_2D_0_165_fusion);
    CNN_SetGenCtrl(&gen_ctrl_S164_CONV_2D_0_165_fusion, "CUSTOM_ACTIVATION_NAME", "expr_26");
    CNN_ExtraActivationArgs_T gen_ctrl_S164_CONV_2D_0_165_fusion_extra_activation_args = {1, {{"SigmoidLUTTable", 256, -2}}};
    CNN_SetGenCtrl(&gen_ctrl_S164_CONV_2D_0_165_fusion, "EXTRA_ACTIVATION_ARGS", &gen_ctrl_S164_CONV_2D_0_165_fusion_extra_activation_args);
    CNN_SetGenCtrl(&gen_ctrl_S164_CONV_2D_0_165_fusion, "INPUT_DATASIZE", AT_OPT_VAL(-1));
    CNN_SetGenCtrl(&gen_ctrl_S164_CONV_2D_0_165_fusion, "OUTPUT_DATASIZE", AT_OPT_VAL(-1));
    // generator for CONV_2D_0_165_fusion
    CNN_ConvolutionNE16("S164_CONV_2D_0_165_fusion", &gen_ctrl_S164_CONV_2D_0_165_fusion,
                        -1, -1, 4, 1, 8,
                        112, 104, 12, 12,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 17,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_GenControl_T gen_ctrl_S165_CONV_2D_0_165_split;
    CNN_InitGenCtrl(&gen_ctrl_S165_CONV_2D_0_165_split);
    CNN_SetGenCtrl(&gen_ctrl_S165_CONV_2D_0_165_split, "ARG_DTYPE", AT_OPT_VAL(ARG_INT));
    
    CNN_SplitLastAxis_Generator2("S165_CONV_2D_0_165_split", &gen_ctrl_S165_CONV_2D_0_165_split, -1, 144, 2, KOP_SPLIT, 52,52);
    
    
    // generator for CONV_2D_0_165_split_copy_qout0
    CNN_Convert("S166_CONV_2D_0_165_split_copy_qout0", -1, -1, 7488, KOP_CONVERT_FP_FP_SCALE);
    ...
    CNN_ConcatLastAxis_Generator2("S173_CONCAT_0_177", &gen_ctrl_S173_CONCAT_0_177, -1, 144, 2, KOP_CONCAT, 52,52);
    ...
    CNN_SplitLastAxis_Generator2("S181_STRIDED_SLICE_0_183_split", &gen_ctrl_S181_STRIDED_SLICE_0_183_split, -1, 432, 3, KOP_SPLIT, 2,2,2);
    ...
    CNN_Convert("S184_CONCAT_0_196_reshape_2_qout0", -1, -1, 864, KOP_CONVERT_FP_FP_SCALE);
    
    
    // generator for expr_1
    s187_kernel_gen("S187_expr_1");
    
    CNN_GenControl_T gen_ctrl_S191_CONV_2D_0_198;
    CNN_InitGenCtrl(&gen_ctrl_S191_CONV_2D_0_198);
    CNN_SetGenCtrl(&gen_ctrl_S191_CONV_2D_0_198, "INPUT_DATASIZE", AT_OPT_VAL(-1));
    CNN_SetGenCtrl(&gen_ctrl_S191_CONV_2D_0_198, "OUTPUT_DATASIZE", AT_OPT_VAL(-1));
    // generator for CONV_2D_0_198
    CNN_ConvolutionNE16("S191_CONV_2D_0_198", &gen_ctrl_S191_CONV_2D_0_198,
                        -1, -1, 4, 1, 8,
                        56, 18, 24, 24,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 17,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_GenControl_T gen_ctrl_S193_STRIDED_SLICE_0_200_split;
    CNN_InitGenCtrl(&gen_ctrl_S193_STRIDED_SLICE_0_200_split);
    CNN_SetGenCtrl(&gen_ctrl_S193_STRIDED_SLICE_0_200_split, "ARG_DTYPE", AT_OPT_VAL(ARG_INT));
    
    CNN_SplitLastAxis_Generator2("S193_STRIDED_SLICE_0_200_split", &gen_ctrl_S193_STRIDED_SLICE_0_200_split, -1, 1728, 3, KOP_SPLIT, 2,2,2);
    
    CNN_GenControl_T gen_ctrl_S194_LOGISTIC_0_212;
    CNN_InitGenCtrl(&gen_ctrl_S194_LOGISTIC_0_212);
    CNN_ExtraActivationArgs_T gen_ctrl_S194_LOGISTIC_0_212_extra_activation_args = {1, {{"SigmoidLUT_u8", 128, -1}}};
    CNN_SetGenCtrl(&gen_ctrl_S194_LOGISTIC_0_212, "EXTRA_ACTIVATION_ARGS", &gen_ctrl_S194_LOGISTIC_0_212_extra_activation_args);
    CNN_SetGenCtrl(&gen_ctrl_S194_LOGISTIC_0_212, "OUTPUT_DATASIZE", AT_OPT_VAL(-1));
    CNN_SetGenCtrl(&gen_ctrl_S194_LOGISTIC_0_212, "INPUT_DATASIZE", AT_OPT_VAL(-1));
    // generator for LOGISTIC_0_212
    CNN_PoolAct_SQ8("S194_LOGISTIC_0_212", &gen_ctrl_S194_LOGISTIC_0_212,
                    576, 2, 3,
                    KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
                    KOP_SIGMOID);
    ...
    CNN_Convert("S196_CONCAT_0_213_reshape_2_qout0", -1, -1, 3456, KOP_CONVERT_FP_FP_SCALE);
    
    CNN_GenControl_T gen_ctrl_S201_CONV_2D_0_215;
    CNN_InitGenCtrl(&gen_ctrl_S201_CONV_2D_0_215);
    CNN_SetGenCtrl(&gen_ctrl_S201_CONV_2D_0_215, "INPUT_DATASIZE", AT_OPT_VAL(-1));
    CNN_SetGenCtrl(&gen_ctrl_S201_CONV_2D_0_215, "OUTPUT_DATASIZE", AT_OPT_VAL(-1));
    // generator for CONV_2D_0_215
    CNN_ConvolutionNE16("S201_CONV_2D_0_215", &gen_ctrl_S201_CONV_2D_0_215,
                        -1, -1, 4, 1, 8,
                        32, 18, 48, 48,
    ...
    CNN_GenControl_T gen_ctrl_S203_STRIDED_SLICE_0_217_split;
    CNN_InitGenCtrl(&gen_ctrl_S203_STRIDED_SLICE_0_217_split);
    CNN_SetGenCtrl(&gen_ctrl_S203_STRIDED_SLICE_0_217_split, "ARG_DTYPE", AT_OPT_VAL(ARG_INT));
    
    CNN_SplitLastAxis_Generator2("S203_STRIDED_SLICE_0_217_split", &gen_ctrl_S203_STRIDED_SLICE_0_217_split, -1, 6912, 3, KOP_SPLIT, 2,2,2);
    
    CNN_GenControl_T gen_ctrl_S204_LOGISTIC_0_229;
    CNN_InitGenCtrl(&gen_ctrl_S204_LOGISTIC_0_229);
    CNN_ExtraActivationArgs_T gen_ctrl_S204_LOGISTIC_0_229_extra_activation_args = {1, {{"SigmoidLUT_u8", 128, -1}}};
    CNN_SetGenCtrl(&gen_ctrl_S204_LOGISTIC_0_229, "EXTRA_ACTIVATION_ARGS", &gen_ctrl_S204_LOGISTIC_0_229_extra_activation_args);
    CNN_SetGenCtrl(&gen_ctrl_S204_LOGISTIC_0_229, "OUTPUT_DATASIZE", AT_OPT_VAL(-1));
    CNN_SetGenCtrl(&gen_ctrl_S204_LOGISTIC_0_229, "INPUT_DATASIZE", AT_OPT_VAL(-1));
    // generator for LOGISTIC_0_229
    CNN_PoolAct_SQ8("S204_LOGISTIC_0_229", &gen_ctrl_S204_LOGISTIC_0_229,
                    2304, 2, 3,
                    KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
                    KOP_SIGMOID);
    ...
    CNN_Convert("S206_CONCAT_0_230_reshape_2_qout0", -1, -1, 13824, KOP_CONVERT_FP_FP_SCALE);
    
    
    // generator for expr_32
    s210_kernel_gen("S210_expr_32");
    
    CNN_GenControl_T gen_ctrl_S211_CONCAT_0_196;
    CNN_InitGenCtrl(&gen_ctrl_S211_CONCAT_0_196);
    CNN_SetGenCtrl(&gen_ctrl_S211_CONCAT_0_196, "ARG_DTYPE", AT_OPT_VAL(ARG_INT));
    
    CNN_ConcatLastAxis_Generator2("S211_CONCAT_0_196", &gen_ctrl_S211_CONCAT_0_196, -1, 432, 3, KOP_CONCAT, 2,2,2);
    
    
    // generator for expr_2
    s214_kernel_gen("S214_expr_2");
    
    
    // generator for expr_34
    s216_kernel_gen("S216_expr_34");
    
    CNN_GenControl_T gen_ctrl_S217_CONCAT_0_213;
    CNN_InitGenCtrl(&gen_ctrl_S217_CONCAT_0_213);
    CNN_SetGenCtrl(&gen_ctrl_S217_CONCAT_0_213, "ARG_DTYPE", AT_OPT_VAL(ARG_INT));
    
    CNN_ConcatLastAxis_Generator2("S217_CONCAT_0_213", &gen_ctrl_S217_CONCAT_0_213, -1, 1728, 3, KOP_CONCAT, 2,2,2);
    
    
    // generator for expr_3
    s220_kernel_gen("S220_expr_3");
    
    
    // generator for expr_35
    s222_kernel_gen("S222_expr_35");
    
    CNN_GenControl_T gen_ctrl_S223_CONCAT_0_230;
    CNN_InitGenCtrl(&gen_ctrl_S223_CONCAT_0_230);
    CNN_SetGenCtrl(&gen_ctrl_S223_CONCAT_0_230, "ARG_DTYPE", AT_OPT_VAL(ARG_INT));
    
    CNN_ConcatLastAxis_Generator2("S223_CONCAT_0_230", &gen_ctrl_S223_CONCAT_0_230, -1, 6912, 3, KOP_CONCAT, 2,2,2);
    
    CNN_GenControl_T gen_ctrl_S227_CONCAT_0_232_reshape_copy;
    CNN_InitGenCtrl(&gen_ctrl_S227_CONCAT_0_232_reshape_copy);
    CNN_SetGenCtrl(&gen_ctrl_S227_CONCAT_0_232_reshape_copy, "ARG_DTYPE", AT_OPT_VAL(ARG_INT));
    
    // generator for CONCAT_0_232_reshape_copy
    CNN_Copy("S227_CONCAT_0_232_reshape_copy", &gen_ctrl_S227_CONCAT_0_232_reshape_copy, 54432, -1);
...
#define GRAPH
    ...
    CreateGraph("YOLOv5CNN",
        /* Arguments either passed or globals */
            CArgs(272,
                ...
                // in: 0.12794 out: 0.06073  BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // in: 0.26926 out: 0.10383  BIASN: 0 PRENORM: 0 NE16_PADVAL: [5] NE16_WOFFSET: [-128]
                ...
                // in: 0.10099 out: 0.02535  BIASN: 0 PRENORM: 0 NE16_PADVAL: [3] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-11.00)*0.02534687<6.18 out_q: -0.55<(u8-20.00)*0.02736553<6.43
                ...
                // in: 0.03433 out: 0.02011  BIASN: 0 PRENORM: 0 NE16_PADVAL: [11] NE16_WOFFSET: [-128]
                ...
                // in: 0.04727 out: 0.02115  BIASN: 0 PRENORM: 0 NE16_PADVAL: [20] NE16_WOFFSET: [-128]
                ...
                // in: 0.03251 out: 0.01753  BIASN: 0 PRENORM: 0 NE16_PADVAL: [13] NE16_WOFFSET: [-128]
                ...
                // in: 0.03167 out: 0.01810  BIASN: 0 PRENORM: 0 NE16_PADVAL: [16] NE16_WOFFSET: [-128]
                ...
                // in q: -0.27<(u8-15.00)*0.01809966<4.34 out_q: -0.55<(u8-24.00)*0.02277872<5.26
                ...
                // in: 0.03016 out: 0.01810  BIASN: 0 PRENORM: 0 NE16_PADVAL: [15] NE16_WOFFSET: [-128]
                ...
                // in: 0.03338 out: 0.01467  BIASN: 0 PRENORM: 0 NE16_PADVAL: [24] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-19.00)*0.01467456<3.46 out_q: -0.27<(u8-15.00)*0.01826197<4.38
                ...
                // in: 0.03213 out: 0.01525  BIASN: 0 PRENORM: 0 NE16_PADVAL: [19] NE16_WOFFSET: [-128]
                ...
                // in: 0.03639 out: 0.01434  BIASN: 0 PRENORM: 0 NE16_PADVAL: [18] NE16_WOFFSET: [-128]
                ...
                // in q: -0.27<(u8-19.00)*0.01434224<3.38 out_q: -0.55<(u8-29.00)*0.01899688<4.29
                ...
                // in: 0.02735 out: 0.01400  BIASN: 0 PRENORM: 0 NE16_PADVAL: [19] NE16_WOFFSET: [-128]
                ...
                // in: 0.02925 out: 0.01633  BIASN: 0 PRENORM: 0 NE16_PADVAL: [29] NE16_WOFFSET: [-128]
                ...
                // in: 0.02896 out: 0.01466  BIASN: 0 PRENORM: 0 NE16_PADVAL: [17] NE16_WOFFSET: [-128]
                ...
                // in: 0.02503 out: 0.01298  BIASN: 0 PRENORM: 0 NE16_PADVAL: [19] NE16_WOFFSET: [-128]
                ...
                // in q: -0.27<(u8-21.00)*0.01298294<3.04 out_q: -0.55<(u8-28.00)*0.01960812<4.45
                ...
                // in: 0.02706 out: 0.01484  BIASN: 0 PRENORM: 0 NE16_PADVAL: [21] NE16_WOFFSET: [-128]
                ...
                // in: 0.02509 out: 0.01293  BIASN: 0 PRENORM: 0 NE16_PADVAL: [28] NE16_WOFFSET: [-128]
                ...
                // in: 0.02797 out: 0.01403  BIASN: 0 PRENORM: 0 NE16_PADVAL: [22] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-20.00)*0.01403083<3.30 out_q: -0.28<(u8-20.00)*0.01403927<3.30
                ...
                // in q: -0.28<(u8-20.00)*0.01403083<3.30 out_q: 0.00<(u8-0.00)*0.01293882<3.30 forced
                ...
                // in q: 0.00<(u8-0.00)*0.01293882<3.30 forced out_q: -0.28<(u8-20.00)*0.01403927<3.30
                ...
                // in: 0.02883 out: 0.01592  BIASN: 0 PRENORM: 0 NE16_PADVAL: [20] NE16_WOFFSET: [-128]
                ...
                // in: 0.02781 out: 0.01536  BIASN: 0 PRENORM: 0 NE16_PADVAL: [17] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-18.00)*0.01536247<3.64 out_q: -0.28<(u8-17.00)*0.01633190<3.89
                ...
                // in q: -0.28<(u8-18.00)*0.01536247<3.64 out_q: -0.27<(u8-17.00)*0.01606502<3.82
                ...
                // in: 0.02694 out: 0.01404  BIASN: 0 PRENORM: 0 NE16_PADVAL: [17] NE16_WOFFSET: [-128]
                ...
                // in: 0.02409 out: 0.01320  BIASN: 0 PRENORM: 0 NE16_PADVAL: [20] NE16_WOFFSET: [-128]
                ...
                // in: 0.02467 out: 0.01404  BIASN: 0 PRENORM: 0 NE16_PADVAL: [21] NE16_WOFFSET: [-128]
                ...
                // in: 0.02554 out: 0.01441  BIASN: 0 PRENORM: 0 NE16_PADVAL: [20] NE16_WOFFSET: [-128]
                ...
                // in: 0.02960 out: 0.01824  BIASN: 0 PRENORM: 0 NE16_PADVAL: [19] NE16_WOFFSET: [-128]
                ...
                // in q: -0.27<(u8-15.00)*0.01824161<4.38 out_q: -0.27<(u8-15.00)*0.01826197<4.38
                ...
                // in q: -0.27<(u8-15.00)*0.01824161<4.38 out_q: -0.27<(u8-15.00)*0.01825755<4.38
                ...
                // in: 0.02749 out: 0.01480  BIASN: 0 PRENORM: 0 NE16_PADVAL: [15] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-19.00)*0.01480311<3.49 out_q: -0.28<(u8-15.00)*0.01870250<4.49
                ...
                // in: 0.03221 out: 0.01838  BIASN: 0 PRENORM: 0 NE16_PADVAL: [19] NE16_WOFFSET: [-128]
                ...
                // in: 0.03531 out: 0.01870  BIASN: 0 PRENORM: 0 NE16_PADVAL: [15] NE16_WOFFSET: [-128]
                ...
                // in: 0.04295 out: 0.02324  BIASN: 0 PRENORM: 0 NE16_PADVAL: [15] NE16_WOFFSET: [-128]
                ...
                // in: 0.02634 out: 0.01826  BIASN: 0 PRENORM: 0 NE16_PADVAL: [12] NE16_WOFFSET: [-128]
                ...
                // in: 0.03272 out: 0.01662  BIASN: 0 PRENORM: 0 NE16_PADVAL: [15] NE16_WOFFSET: [-128]
                ...
                // in q: -0.28<(u8-17.00)*0.01661627<3.95 out_q: -0.28<(u8-17.00)*0.01662195<3.96
                ...
                // in: 0.03146 out: 0.01750  BIASN: 0 PRENORM: 0 NE16_PADVAL: [17] NE16_WOFFSET: [-128]
                ...
                // in: 0.03026 out: 0.01662  BIASN: 0 PRENORM: 0 NE16_PADVAL: [16] NE16_WOFFSET: [-128]
                ...
                // in: 0.03297 out: 0.01683  BIASN: 0 PRENORM: 0 NE16_PADVAL: [17] NE16_WOFFSET: [-128]
                ...
                // in: 0.02574 out: 0.01607  BIASN: 0 PRENORM: 0 NE16_PADVAL: [17] NE16_WOFFSET: [-128]
                ...
                TCArgInfo("unsigned char * __restrict__", "S164_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S164_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S164_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S164_Mul_shift.tensor", 1, 1, 8, 0)),
                // in: 0.02654 out: 0.01698  BIASN: 0 PRENORM: 0 NE16_PADVAL: [17] NE16_WOFFSET: [-128]
                ...
                // in q: -0.27<(u8-16.00)*0.01697675<4.06 out_q: -0.27<(u8-16.00)*0.01700514<4.06
                ...
                // in: 0.02711 out: 0.01420  BIASN: 0 PRENORM: 0 NE16_PADVAL: [16] NE16_WOFFSET: [-128]
                ...
                // in: 0.01918 out: 0.01701  BIASN: 0 PRENORM: 0 NE16_PADVAL: [20] NE16_WOFFSET: [-128]
                ...
                // in: 0.02397 out: 0.01282  BIASN: 0 PRENORM: 0 NE16_PADVAL: [16] NE16_WOFFSET: [-128]
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -1.01<(u8-128.00)*0.00792632<1.01 forced
                ...
                TCArgInfo("unsigned char * __restrict__", "S201_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S201_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S201_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S201_Mul_shift.tensor", 1, 1, 8, 0)),
        ...
        CArgs(123,
            ...
            TCArgInfo("unsigned char * __restrict__", "S164_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S165_Output_0", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S165_Output_1", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            ...
            TCArgInfo("unsigned char * __restrict__", "S193_Output_2", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S193_Output_0", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S193_Output_1", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            ...
            TCArgInfo("unsigned char * __restrict__", "S203_Output_2", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S203_Output_1", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S203_Output_0", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S204_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            ...
            TCArgInfo("unsigned char * __restrict__", "S214_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
    ...
    AddStackedTensors(
        "S225_Output",
        3, "S223_Output", "S217_Output", "S211_Output"
    );

    // Node S3_CONV_2D_0_0_fusion inq 0.00<(u8-0.00)*0.00392157<1.00 weightsq chan<(u8-128.00)*chan<chan outq -0.30<(u8-5.00)*0.06073321<15.18 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S6_CONV_2D_0_4_fusion inq -0.30<(u8-5.00)*0.06073321<15.18 weightsq chan<(u8-128.00)*chan<chan outq -0.31<(u8-3.00)*0.10382751<26.16 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S9_CONV_2D_0_7_fusion inq -0.31<(u8-3.00)*0.10382751<26.16 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-11.00)*0.02534687<6.18 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_7_split inq -0.28<(u8-11.00)*0.02534687<6.18 outq -0.28<(u8-11.00)*0.02534687<6.18
    ...
    // Node CONV_2D_0_7_split_copy_qout0 inq -0.28<(u8-11.00)*0.02534687<6.18 outq -0.55<(u8-20.00)*0.02736553<6.43
    ...
    // Node S14_CONV_2D_0_10_fusion inq -0.28<(u8-11.00)*0.02534687<6.18 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-14.00)*0.02010621<4.85 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S17_CONV_2D_0_13 inq -0.28<(u8-14.00)*0.02010621<4.85 weightsq chan<(u8-128.00)*chan<chan outq -6.29<(u8-126.00)*0.04991524<6.44 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_0 in_qs [-6.29<(u8-126.00)*0.04991524<6.44,-0.28<(u8-11.00)*0.02534687<6.18] out_qs [-0.55<(u8-20.00)*0.02736553<6.43]
    AddNode("S18_expr_0",
        Bindings(4,
    ...
    // Node CONCAT_0_20 inq -0.55<(u8-20.00)*0.02736553<6.43 outq -0.55<(u8-20.00)*0.02736553<6.43
    ...
    // Node S22_CONV_2D_0_21_fusion inq -0.55<(u8-20.00)*0.02736553<6.43 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-13.00)*0.02115196<5.12 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S25_CONV_2D_0_25_fusion inq -0.27<(u8-13.00)*0.02115196<5.12 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-16.00)*0.01753430<4.19 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S28_CONV_2D_0_28_fusion inq -0.28<(u8-16.00)*0.01753430<4.19 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-15.00)*0.01809966<4.34 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_28_split inq -0.27<(u8-15.00)*0.01809966<4.34 outq -0.27<(u8-15.00)*0.01809966<4.34
    ...
    // Node CONV_2D_0_28_split_copy_qout0 inq -0.27<(u8-15.00)*0.01809966<4.34 outq -0.55<(u8-24.00)*0.02277872<5.26
    ...
    // Node S33_CONV_2D_0_31_fusion inq -0.27<(u8-15.00)*0.01809966<4.34 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-15.00)*0.01809634<4.34 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S36_CONV_2D_0_34 inq -0.27<(u8-15.00)*0.01809634<4.34 weightsq chan<(u8-128.00)*chan<chan outq -4.41<(u8-134.00)*0.03292686<3.98 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_4 in_qs [-4.41<(u8-134.00)*0.03292686<3.98,-0.27<(u8-15.00)*0.01809966<4.34] out_qs [-0.55<(u8-24.00)*0.02277872<5.26]
    AddNode("S37_expr_4",
        Bindings(4,
    ...
    // Node CONCAT_0_41 inq -0.55<(u8-24.00)*0.02277872<5.26 outq -0.55<(u8-24.00)*0.02277872<5.26
    ...
    // Node S41_CONV_2D_0_42_fusion inq -0.55<(u8-24.00)*0.02277872<5.26 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-19.00)*0.01467456<3.46 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_42_fusion_qout0 inq -0.28<(u8-19.00)*0.01467456<3.46 outq -0.27<(u8-15.00)*0.01826197<4.38
    ...
    // Node S45_CONV_2D_0_46_fusion inq -0.28<(u8-19.00)*0.01467456<3.46 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-18.00)*0.01524714<3.61 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S48_CONV_2D_0_49_fusion inq -0.27<(u8-18.00)*0.01524714<3.61 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-19.00)*0.01434224<3.38 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_49_split inq -0.27<(u8-19.00)*0.01434224<3.38 outq -0.27<(u8-19.00)*0.01434224<3.38
    ...
    // Node CONV_2D_0_49_split_copy_qout0 inq -0.27<(u8-19.00)*0.01434224<3.38 outq -0.55<(u8-29.00)*0.01899688<4.29
    ...
    // Node S53_CONV_2D_0_52_fusion inq -0.27<(u8-19.00)*0.01434224<3.38 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-20.00)*0.01399536<3.29 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S56_CONV_2D_0_55 inq -0.28<(u8-20.00)*0.01399536<3.29 weightsq chan<(u8-128.00)*chan<chan outq -3.93<(u8-134.00)*0.02935307<3.55 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_5 in_qs [-3.93<(u8-134.00)*0.02935307<3.55,-0.27<(u8-19.00)*0.01434224<3.38] out_qs [-0.55<(u8-29.00)*0.01899688<4.29]
    AddNode("S57_expr_5",
        Bindings(4,
    ...
    // Node CONCAT_0_62 inq -0.55<(u8-29.00)*0.01899688<4.29 outq -0.55<(u8-29.00)*0.01899688<4.29
    ...
    // Node S61_CONV_2D_0_63_fusion inq -0.55<(u8-29.00)*0.01899688<4.29 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-17.00)*0.01633190<3.89 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S64_CONV_2D_0_67_fusion inq -0.28<(u8-17.00)*0.01633190<3.89 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-19.00)*0.01465987<3.46 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S67_CONV_2D_0_70_fusion inq -0.28<(u8-19.00)*0.01465987<3.46 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-21.00)*0.01298294<3.04 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_70_split inq -0.27<(u8-21.00)*0.01298294<3.04 outq -0.27<(u8-21.00)*0.01298294<3.04
    ...
    // Node CONV_2D_0_70_split_copy_qout0 inq -0.27<(u8-21.00)*0.01298294<3.04 outq -0.55<(u8-28.00)*0.01960812<4.45
    ...
    // Node S72_CONV_2D_0_73_fusion inq -0.27<(u8-21.00)*0.01298294<3.04 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-19.00)*0.01484282<3.50 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S75_CONV_2D_0_76 inq -0.28<(u8-19.00)*0.01484282<3.50 weightsq chan<(u8-128.00)*chan<chan outq -3.02<(u8-111.00)*0.02720590<3.92 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_6 in_qs [-3.02<(u8-111.00)*0.02720590<3.92,-0.27<(u8-21.00)*0.01298294<3.04] out_qs [-0.55<(u8-28.00)*0.01960812<4.45]
    AddNode("S76_expr_6",
        Bindings(4,
    ...
    // Node CONCAT_0_83 inq -0.55<(u8-28.00)*0.01960812<4.45 outq -0.55<(u8-28.00)*0.01960812<4.45
    ...
    // Node S80_CONV_2D_0_84_fusion inq -0.55<(u8-28.00)*0.01960812<4.45 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-22.00)*0.01293339<3.01 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S83_CONV_2D_0_87_fusion inq -0.28<(u8-22.00)*0.01293339<3.01 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-20.00)*0.01403083<3.30 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_87_fusion_qout0 inq -0.28<(u8-20.00)*0.01403083<3.30 outq -0.28<(u8-20.00)*0.01403927<3.30
    ...
    // Node CONV_2D_0_87_fusion_qout0_0 inq -0.28<(u8-20.00)*0.01403083<3.30 outq 0.00<(u8-0.00)*0.01293882<3.30 forced
    AddNode("S85_CONV_2D_0_87_fusion_qout0_0",
        Bindings(3,
            GNodeArg(GNA_IN, "S83_Output", 0),
    ...
    // Node MAX_POOL_2D_0_90 inq 0.00<(u8-0.00)*0.01293882<3.30 forced outq 0.00<(u8-0.00)*0.01293882<3.30 forced
    ...
    // Node MAX_POOL_2D_0_91 inq 0.00<(u8-0.00)*0.01293882<3.30 forced outq 0.00<(u8-0.00)*0.01293882<3.30 forced
    ...
    // Node MAX_POOL_2D_0_92 inq 0.00<(u8-0.00)*0.01293882<3.30 forced outq 0.00<(u8-0.00)*0.01293882<3.30 forced
    ...
    // Node MAX_POOL_2D_0_92_qout0 inq 0.00<(u8-0.00)*0.01293882<3.30 forced outq -0.28<(u8-20.00)*0.01403927<3.30
    ...
    // Node MAX_POOL_2D_0_91_qout0 inq 0.00<(u8-0.00)*0.01293882<3.30 forced outq -0.28<(u8-20.00)*0.01403927<3.30
    ...
    // Node MAX_POOL_2D_0_90_qout0 inq 0.00<(u8-0.00)*0.01293882<3.30 forced outq -0.28<(u8-20.00)*0.01403927<3.30
    ...
    // Node CONCAT_0_93 inq -0.28<(u8-20.00)*0.01403927<3.30 outq -0.28<(u8-20.00)*0.01403927<3.30
    ...
    // Node S95_CONV_2D_0_94_fusion inq -0.28<(u8-20.00)*0.01403927<3.30 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-17.00)*0.01591804<3.79 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S98_CONV_2D_0_97_fusion inq -0.27<(u8-17.00)*0.01591804<3.79 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-18.00)*0.01536247<3.64 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node RESIZE_NN_0_100 inq -0.28<(u8-18.00)*0.01536247<3.64 outq -0.28<(u8-18.00)*0.01536247<3.64
    ...
    // Node RESIZE_NN_0_100_qout0 inq -0.28<(u8-18.00)*0.01536247<3.64 outq -0.28<(u8-17.00)*0.01633190<3.89
    ...
    // Node CONCAT_0_101 inq -0.28<(u8-17.00)*0.01633190<3.89 outq -0.28<(u8-17.00)*0.01633190<3.89
    ...
    // Node CONV_2D_0_97_fusion_qout0 inq -0.28<(u8-18.00)*0.01536247<3.64 outq -0.27<(u8-17.00)*0.01606502<3.82
    ...
    // Node S105_CONV_2D_0_102_fusion inq -0.28<(u8-17.00)*0.01633190<3.89 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-20.00)*0.01403969<3.30 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_102_split inq -0.28<(u8-20.00)*0.01403969<3.30 outq -0.28<(u8-20.00)*0.01403969<3.30
    ...
    // Node S109_CONV_2D_0_105_fusion inq -0.28<(u8-20.00)*0.01403969<3.30 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-21.00)*0.01320323<3.09 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S112_CONV_2D_0_108_fusion inq -0.28<(u8-21.00)*0.01320323<3.09 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-20.00)*0.01403969<3.30 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_114 inq -0.28<(u8-20.00)*0.01403969<3.30 outq -0.28<(u8-20.00)*0.01403969<3.30
    ...
    // Node S116_CONV_2D_0_115_fusion inq -0.28<(u8-20.00)*0.01403969<3.30 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-19.00)*0.01441240<3.40 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S119_CONV_2D_0_118_fusion inq -0.27<(u8-19.00)*0.01441240<3.40 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-15.00)*0.01824161<4.38 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node RESIZE_NN_0_121 inq -0.27<(u8-15.00)*0.01824161<4.38 outq -0.27<(u8-15.00)*0.01824161<4.38
    ...
    // Node RESIZE_NN_0_121_qout0 inq -0.27<(u8-15.00)*0.01824161<4.38 outq -0.27<(u8-15.00)*0.01826197<4.38
    ...
    // Node CONCAT_0_122 inq -0.27<(u8-15.00)*0.01826197<4.38 outq -0.27<(u8-15.00)*0.01826197<4.38
    ...
    // Node CONV_2D_0_118_fusion_qout0 inq -0.27<(u8-15.00)*0.01824161<4.38 outq -0.27<(u8-15.00)*0.01825755<4.38
    ...
    // Node S126_CONV_2D_0_123_fusion inq -0.27<(u8-15.00)*0.01826197<4.38 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-19.00)*0.01480311<3.49 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_123_split inq -0.28<(u8-19.00)*0.01480311<3.49 outq -0.28<(u8-19.00)*0.01480311<3.49
    ...
    // Node CONV_2D_0_123_split_copy_qout0 inq -0.28<(u8-19.00)*0.01480311<3.49 outq -0.28<(u8-15.00)*0.01870250<4.49
    ...
    // Node S131_CONV_2D_0_126_fusion inq -0.28<(u8-19.00)*0.01480311<3.49 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-15.00)*0.01838331<4.41 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S134_CONV_2D_0_129_fusion inq -0.28<(u8-15.00)*0.01838331<4.41 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-15.00)*0.01870250<4.49 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_135 inq -0.28<(u8-15.00)*0.01870250<4.49 outq -0.28<(u8-15.00)*0.01870250<4.49
    ...
    // Node S138_CONV_2D_0_136_fusion inq -0.28<(u8-15.00)*0.01870250<4.49 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-12.00)*0.02323687<5.65 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S141_CONV_2D_0_140_fusion inq -0.28<(u8-12.00)*0.02323687<5.65 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-15.00)*0.01825755<4.38 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_143 inq -0.27<(u8-15.00)*0.01825755<4.38 outq -0.27<(u8-15.00)*0.01825755<4.38
    ...
    // Node S145_CONV_2D_0_144_fusion inq -0.27<(u8-15.00)*0.01825755<4.38 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-17.00)*0.01661627<3.95 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONV_2D_0_144_split inq -0.28<(u8-17.00)*0.01661627<3.95 outq -0.28<(u8-17.00)*0.01661627<3.95
    ...
    // Node CONV_2D_0_144_split_copy_qout0 inq -0.28<(u8-17.00)*0.01661627<3.95 outq -0.28<(u8-17.00)*0.01662195<3.96
    AddNode("S147_CONV_2D_0_144_split_copy_qout0",
        Bindings(3,
    ...
    // Node S150_CONV_2D_0_147_fusion inq -0.28<(u8-17.00)*0.01661627<3.95 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-16.00)*0.01750198<4.18 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S150_CONV_2D_0_147_fusion",
        Bindings(8,
    ...
    // Node S153_CONV_2D_0_150_fusion inq -0.28<(u8-16.00)*0.01750198<4.18 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-17.00)*0.01662195<3.96 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S153_CONV_2D_0_150_fusion",
        Bindings(8,
    ...
    // Node CONCAT_0_156 inq -0.28<(u8-17.00)*0.01662195<3.96 outq -0.28<(u8-17.00)*0.01662195<3.96
    AddNode("S154_CONCAT_0_156",
        Bindings(3,
    ...
    // Node S157_CONV_2D_0_157_fusion inq -0.28<(u8-17.00)*0.01662195<3.96 weightsq chan<(u8-128.00)*chan<chan outq -0.29<(u8-17.00)*0.01683005<4.01 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S157_CONV_2D_0_157_fusion",
        Bindings(8,
    ...
    // Node S160_CONV_2D_0_161_fusion inq -0.29<(u8-17.00)*0.01683005<4.01 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-17.00)*0.01606502<3.82 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S160_CONV_2D_0_161_fusion",
        Bindings(8,
    ...
    // Node CONCAT_0_164 inq -0.27<(u8-17.00)*0.01606502<3.82 outq -0.27<(u8-17.00)*0.01606502<3.82
    AddNode("S161_CONCAT_0_164",
        Bindings(3,
    ...
    // Node S164_CONV_2D_0_165_fusion inq -0.27<(u8-17.00)*0.01606502<3.82 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-16.00)*0.01697675<4.06 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S164_CONV_2D_0_165_fusion",
        Bindings(8,
    ...
    // Node CONV_2D_0_165_split inq -0.27<(u8-16.00)*0.01697675<4.06 outq -0.27<(u8-16.00)*0.01697675<4.06
    AddNode("S165_CONV_2D_0_165_split",
        Bindings(3,
            GNodeArg(GNA_IN, "S164_Output", 0),
            GNodeArg(GNA_OUT, "S165_Output_0", 0),
            GNodeArg(GNA_OUT, "S165_Output_1", 0)
        )
    );
    // Node CONV_2D_0_165_split_copy_qout0 inq -0.27<(u8-16.00)*0.01697675<4.06 outq -0.27<(u8-16.00)*0.01700514<4.06
    AddNode("S166_CONV_2D_0_165_split_copy_qout0",
        Bindings(3,
            GNodeArg(GNA_IN, "S165_Output_1", 0),
            GNodeArg(GNA_OUT, "S166_Output", 0),
            GNodeArg(GNA_IN, "S166_Infos", 0)
        )
    );
    // Node S169_CONV_2D_0_168_fusion inq -0.27<(u8-16.00)*0.01697675<4.06 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-20.00)*0.01420328<3.34 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S169_CONV_2D_0_168_fusion",
        Bindings(8,
            GNodeArg(GNA_IN, "S165_Output_0", 0),
    ...
    // Node S172_CONV_2D_0_171_fusion inq -0.28<(u8-20.00)*0.01420328<3.34 weightsq chan<(u8-128.00)*chan<chan outq -0.27<(u8-16.00)*0.01700514<4.06 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_177 inq -0.27<(u8-16.00)*0.01700514<4.06 outq -0.27<(u8-16.00)*0.01700514<4.06
    ...
    // Node S176_CONV_2D_0_178_fusion inq -0.27<(u8-16.00)*0.01700514<4.06 weightsq chan<(u8-128.00)*chan<chan outq -0.28<(u8-22.00)*0.01281933<2.99 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S179_CONV_2D_0_181 inq -0.28<(u8-22.00)*0.01281933<2.99 weightsq chan<(u8-128.00)*chan<chan outq -6.29<(u8-128.00)*0.04913386<6.24 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node CONCAT_0_196_reshape_2_qout0 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -1.01<(u8-128.00)*0.00792632<1.01 forced
    AddNode("S184_CONCAT_0_196_reshape_2_qout0",
        Bindings(3,
    ...
    // Node expr_1 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-10.58<(i8-0.00)*0.08267717<10.50,-0.00<(i8-0.00)*0.00002051<0.00] out_qs [-1.01<(u8-128.00)*0.00792632<1.01 forced]
    AddNode("S187_expr_1",
        Bindings(5,
    ...
    // Node S191_CONV_2D_0_198 inq -0.29<(u8-17.00)*0.01683005<4.01 weightsq chan<(u8-128.00)*chan<chan outq -6.29<(u8-128.00)*0.04913386<6.24 forced biasesq chan<(i32-0.00)*chan<chan
    AddNode("S191_CONV_2D_0_198",
        Bindings(7,
            GNodeArg(GNA_IN, "S157_Output", 0),
    ...
    AddNode("S193_STRIDED_SLICE_0_200_split",
        Bindings(4,
            GNodeArg(GNA_IN, "S191_Output", 0),
            GNodeArg(GNA_OUT, "S193_Output_0", 0),
            GNodeArg(GNA_OUT, "S193_Output_1", 0),
            GNodeArg(GNA_OUT, "S193_Output_2", 0)
        )
    );
    // Node LOGISTIC_0_212 inq -6.29<(u8-128.00)*0.04913386<6.24 forced outq 0.00<(u8-0.00)*0.00392157<1.00
    AddNode("S194_LOGISTIC_0_212",
        Bindings(4,
            GNodeArg(GNA_IN, "S193_Output_2", 0),
            GNodeArg(GNA_OUT, "S194_Output", 0),
            GNodeArg(GNA_IN, "S194_Infos", 0),
            GNodeArg(GNA_IN, "SigmoidLUT_u8", 0)
        )
    );
    // Node CONCAT_0_213_reshape_2_qout0 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -1.01<(u8-128.00)*0.00792632<1.01 forced
    AddNode("S196_CONCAT_0_213_reshape_2_qout0",
        Bindings(3,
    ...
    // Node S201_CONV_2D_0_215 inq -0.28<(u8-12.00)*0.02323687<5.65 weightsq chan<(u8-128.00)*chan<chan outq -6.29<(u8-128.00)*0.04913386<6.24 forced biasesq chan<(i32-0.00)*chan<chan
    AddNode("S201_CONV_2D_0_215",
        Bindings(7,
            GNodeArg(GNA_IN, "S138_Output", 0),
            GNodeArg(GNA_IN, "Arith_constant87", 0),
            GNodeArg(GNA_IN, "Arith_constant34", 0),
            GNodeArg(GNA_OUT, "S201_Output", 0),
            GNodeArg(GNA_IN, "S201_Mul_scale", 0),
            GNodeArg(GNA_IN, "S201_Mul_shift", 0),
    ...
    AddNode("S203_STRIDED_SLICE_0_217_split",
        Bindings(4,
            GNodeArg(GNA_IN, "S201_Output", 0),
            GNodeArg(GNA_OUT, "S203_Output_0", 0),
            GNodeArg(GNA_OUT, "S203_Output_1", 0),
            GNodeArg(GNA_OUT, "S203_Output_2", 0)
        )
    );
    // Node LOGISTIC_0_229 inq -6.29<(u8-128.00)*0.04913386<6.24 forced outq 0.00<(u8-0.00)*0.00392157<1.00
    AddNode("S204_LOGISTIC_0_229",
        Bindings(4,
            GNodeArg(GNA_IN, "S203_Output_2", 0),
            GNodeArg(GNA_OUT, "S204_Output", 0),
            GNodeArg(GNA_IN, "S204_Infos", 0),
            GNodeArg(GNA_IN, "SigmoidLUT_u8", 0)
        )
    );
    // Node CONCAT_0_230_reshape_2_qout0 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -1.01<(u8-128.00)*0.00792632<1.01 forced
    AddNode("S206_CONCAT_0_230_reshape_2_qout0",
        Bindings(3,
    ...
    // Node expr_32 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-1503.75<(i8-0.00)*11.74803150<1492.00,-0.00<(i8-0.00)*0.00002051<0.00] out_qs [-1.01<(u8-128.00)*0.00792632<1.01 forced]
    AddNode("S210_expr_32",
        Bindings(5,
    ...
    // Node CONCAT_0_196 inq -1.01<(u8-128.00)*0.00792632<1.01 forced outq -1.01<(u8-128.00)*0.00792632<1.01 forced
    AddNode("S211_CONCAT_0_196",
        Bindings(4,
    ...
    // Node expr_2 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-22.68<(i8-0.00)*0.17716535<22.50,-0.00<(i8-0.00)*0.00002051<0.00] out_qs [-1.01<(u8-128.00)*0.00792632<1.01 forced]
    AddNode("S214_expr_2",
        Bindings(5,
    ...
    // Node expr_34 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-479.75<(i8-0.00)*3.74803150<476.00,-0.00<(i8-0.00)*0.00002051<0.00] out_qs [-1.01<(u8-128.00)*0.00792632<1.01 forced]
    AddNode("S216_expr_34",
        Bindings(5,
            GNodeArg(GNA_IN, "S193_Output_1", 0),
    ...
    // Node CONCAT_0_213 inq -1.01<(u8-128.00)*0.00792632<1.01 forced outq -1.01<(u8-128.00)*0.00792632<1.01 forced
    AddNode("S217_CONCAT_0_213",
        Bindings(4,
    ...
    // Node expr_3 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-46.87<(i8-0.00)*0.36614173<46.50,-0.00<(i8-0.00)*0.00002051<0.00] out_qs [-1.01<(u8-128.00)*0.00792632<1.01 forced]
    AddNode("S220_expr_3",
        Bindings(5,
            GNodeArg(GNA_IN, "S203_Output_0", 0),
    ...
    // Node expr_35 in_qs [-6.29<(u8-128.00)*0.04913386<6.24,-133.04<(i8-0.00)*1.03937008<132.00,-0.00<(i8-0.00)*0.00002051<0.00] out_qs [-1.01<(u8-128.00)*0.00792632<1.01 forced]
    AddNode("S222_expr_35",
        Bindings(5,
            GNodeArg(GNA_IN, "S203_Output_1", 0),
    ...
    // Node CONCAT_0_230 inq -1.01<(u8-128.00)*0.00792632<1.01 forced outq -1.01<(u8-128.00)*0.00792632<1.01 forced
    AddNode("S223_CONCAT_0_230",
        Bindings(4,
    ...
    // Node CONCAT_0_232_reshape_copy inq -1.01<(u8-128.00)*0.00792632<1.01 forced outq -1.01<(u8-128.00)*0.00792632<1.01 forced
    AddNode("S227_CONCAT_0_232_reshape_copy",
        Bindings(2,
