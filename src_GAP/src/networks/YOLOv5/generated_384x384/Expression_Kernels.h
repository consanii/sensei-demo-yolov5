...
void s187_kernel(s187_kernel_args_t *Args);

void s214_kernel(s214_kernel_args_t *Args);

void s220_kernel(s220_kernel_args_t *Args);
...
void s210_kernel(s210_kernel_args_t *Args);

void s216_kernel(s216_kernel_args_t *Args);

void s222_kernel(s222_kernel_args_t *Args);
